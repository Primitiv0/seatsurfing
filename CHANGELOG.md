...
## [1.44.0](https://github.com/Primitiv0/seatsurfing/compare/v1.43.0...v1.44.0) (2025-09-27)


### Features

* add ability to approve bookings ([#857](https://github.com/Primitiv0/seatsurfing/issues/857)) ([6425ed5](https://github.com/Primitiv0/seatsurfing/commit/6425ed53be365208b6480e2020716d36d5263e2e))
* add ability to assign attributes to spaces in Admin UI ([#696](https://github.com/Primitiv0/seatsurfing/issues/696)) ([8fda071](https://github.com/Primitiv0/seatsurfing/commit/8fda071e4064d1ec55d6df22e25ab5819e88884c))
* add ability to change org name and contact details in Admin UI ([#1140](https://github.com/Primitiv0/seatsurfing/issues/1140)) ([b054dc5](https://github.com/Primitiv0/seatsurfing/commit/b054dc5082d18eb03163b6455d84b98bfb333dd7))
* add ability to download iCalendar (.ics) events ([#807](https://github.com/Primitiv0/seatsurfing/issues/807)) ([bf630ef](https://github.com/Primitiv0/seatsurfing/commit/bf630efac91dfad9b8c55213872a354ab571d963))
* add ability to specify approver and allowed booker groups per space ([#850](https://github.com/Primitiv0/seatsurfing/issues/850)) ([f840abc](https://github.com/Primitiv0/seatsurfing/commit/f840abc7ff9c0a09b47086527b9689a778619516))
* add email footer support ([#811](https://github.com/Primitiv0/seatsurfing/issues/811)) ([0e029d0](https://github.com/Primitiv0/seatsurfing/commit/0e029d0b2f2154c99600a64d59dbb3f6b9389ca8))
* add Estonian translation for Booking UI ([#732](https://github.com/Primitiv0/seatsurfing/issues/732)) ([b5f106a](https://github.com/Primitiv0/seatsurfing/commit/b5f106a64098742721f44c9fe8bb77c4e748f176))
* add in-memory-cache for settings to improve performance ([#991](https://github.com/Primitiv0/seatsurfing/issues/991)) ([bc19625](https://github.com/Primitiv0/seatsurfing/commit/bc1962507ee37f1761c1ae9a0178d51aa0be4bdf))
* add mail notifications ([#824](https://github.com/Primitiv0/seatsurfing/issues/824)) ([b69494f](https://github.com/Primitiv0/seatsurfing/commit/b69494ffade72c6ce80f840e99156d416b6b4370))
* add mail notifications if a booking was approved, updated or deleted ([#1282](https://github.com/Primitiv0/seatsurfing/issues/1282)) ([e2220e0](https://github.com/Primitiv0/seatsurfing/commit/e2220e0c8d0c6e392d403f704cdddf630f60b22a))
* add optional info to subject placeholder ([#1281](https://github.com/Primitiv0/seatsurfing/issues/1281)) ([85d9ab5](https://github.com/Primitiv0/seatsurfing/commit/85d9ab555a8e698a264dc3796fc4e5ed20793512))
* add proxy to frontends in dev mode ([#1073](https://github.com/Primitiv0/seatsurfing/issues/1073)) ([f6e4a14](https://github.com/Primitiv0/seatsurfing/commit/f6e4a14edc1725ddb63b07d0bc8222f3d23c7524))
* add PUBLIC_SCHEME and PUBLIC_PORT environment variables ([#899](https://github.com/Primitiv0/seatsurfing/issues/899)) ([54353b2](https://github.com/Primitiv0/seatsurfing/commit/54353b22439810f598744e9edc557c51db79dd32))
* add subject to email booking notification ([#1270](https://github.com/Primitiv0/seatsurfing/issues/1270)) ([9dd7bd5](https://github.com/Primitiv0/seatsurfing/commit/9dd7bd56309efe12bd8fdebe5d45c8b09474a39d))
* add support for html emails ([#813](https://github.com/Primitiv0/seatsurfing/issues/813)) ([a5db476](https://github.com/Primitiv0/seatsurfing/commit/a5db476962198a7e8768dbb3e1d7798b6d54fb74))
* add user groups support ([#829](https://github.com/Primitiv0/seatsurfing/issues/829)) ([5b05a83](https://github.com/Primitiv0/seatsurfing/commit/5b05a83f7f7efbcf3d9b7905cbbe54183ea2798c))
* allow canceling a recurring booking from the search view ([#993](https://github.com/Primitiv0/seatsurfing/issues/993)) ([08a1fd7](https://github.com/Primitiv0/seatsurfing/commit/08a1fd751d68cacb4181eefb02e67ae28b025154))
* booking cards on admin dashboard link to filtered bookings view ([#1287](https://github.com/Primitiv0/seatsurfing/issues/1287)) ([479984d](https://github.com/Primitiv0/seatsurfing/commit/479984dcdcea21c37874800d1fd2347b183456e0))
* display subscription upgrade hint in Admin UI (cloud-hosted only) ([#1075](https://github.com/Primitiv0/seatsurfing/issues/1075)) ([61bbdaa](https://github.com/Primitiv0/seatsurfing/commit/61bbdaa9cc12be9bdbb28abf09c5a489a0e063fb))
* display upgrade hints in approvals and groups page (cloud-hosted only) ([#1087](https://github.com/Primitiv0/seatsurfing/issues/1087)) ([0dcece1](https://github.com/Primitiv0/seatsurfing/commit/0dcece1e9006900b619b54847f726b1e242070de))
* domain accessibility validation ([#760](https://github.com/Primitiv0/seatsurfing/issues/760)) ([6b3de16](https://github.com/Primitiv0/seatsurfing/commit/6b3de168c5eaefd30dc7a66453c74ee2b8ee2af3))
* endpoint for querying a single space's availability ([#924](https://github.com/Primitiv0/seatsurfing/issues/924)) ([0408cec](https://github.com/Primitiv0/seatsurfing/commit/0408cec7439987ada262936e6706605638e31368))
* feature flag for auth providers ([#862](https://github.com/Primitiv0/seatsurfing/issues/862)) ([f01703a](https://github.com/Primitiv0/seatsurfing/commit/f01703a7f15675fe4ce2ad37f970894194d50b2f))
* feedback button in admin ui (cloud-hosted only) ([#1092](https://github.com/Primitiv0/seatsurfing/issues/1092)) ([cf81173](https://github.com/Primitiv0/seatsurfing/commit/cf81173c6351898aa4251ec781922b3986495c23))
* healthcheck route for native docker healtcheck instruction ([#1069](https://github.com/Primitiv0/seatsurfing/issues/1069)) ([654ec0b](https://github.com/Primitiv0/seatsurfing/commit/654ec0b515559b1ebe30ab25ba2dd58cda8c111a))
* improve visibility of search bar in admin UI ([#1318](https://github.com/Primitiv0/seatsurfing/issues/1318)) ([0f04875](https://github.com/Primitiv0/seatsurfing/commit/0f04875dd6c898c67e71c177c2bcc1d892511d39))
* indicate recurring bookings in admin ui ([#994](https://github.com/Primitiv0/seatsurfing/issues/994)) ([e3a01ed](https://github.com/Primitiv0/seatsurfing/commit/e3a01ed6c1750b22166ac122ae3171be3aeea801))
* introduce feature flags for 'no user limit' and 'custom domains' ([#758](https://github.com/Primitiv0/seatsurfing/issues/758)) ([9b920e2](https://github.com/Primitiv0/seatsurfing/commit/9b920e2846b2bae41d0b1277dbc0c2f07ac8a3eb))
* intuitive way of navigating the map by adding react-zoom-pan-pinch to the Booking UI ([#885](https://github.com/Primitiv0/seatsurfing/issues/885)) ([da4eae7](https://github.com/Primitiv0/seatsurfing/commit/da4eae73417e0eb3df56ecf377f3dae1f55178f8))
* option for mandatory booking subjects per space  ([#921](https://github.com/Primitiv0/seatsurfing/issues/921)) ([d6c6555](https://github.com/Primitiv0/seatsurfing/commit/d6c6555cf7d4d1e268862b4806d4d4968d0f6857))
* recurring bookings ([#947](https://github.com/Primitiv0/seatsurfing/issues/947)) ([13b95ec](https://github.com/Primitiv0/seatsurfing/commit/13b95ecbf1a7717eadd025b50bf08f04ce32b407))
* refactored credentials handling and persistence in frontends ([#1174](https://github.com/Primitiv0/seatsurfing/issues/1174)) ([f80b630](https://github.com/Primitiv0/seatsurfing/commit/f80b630f2a3dd713775d9ea6f812e177594d7a02))
* restrict space-booking by group memberships ([#851](https://github.com/Primitiv0/seatsurfing/issues/851)) ([fbec1da](https://github.com/Primitiv0/seatsurfing/commit/fbec1da168c980c57a06aeb1771505388511526c))
* service accounts ([#923](https://github.com/Primitiv0/seatsurfing/issues/923)) ([bed7c72](https://github.com/Primitiv0/seatsurfing/commit/bed7c72c71f9c897d6174a5f2c63c8c814d2b895))
* show and search for space attributes in Booking UI ([#702](https://github.com/Primitiv0/seatsurfing/issues/702)) ([7419470](https://github.com/Primitiv0/seatsurfing/commit/7419470d61ee8bebbc05a41609099b1ee3bd00ce))
* show default time zone on area admin page ([#1316](https://github.com/Primitiv0/seatsurfing/issues/1316)) ([0aaadab](https://github.com/Primitiv0/seatsurfing/commit/0aaadabc21f3ec6991adaac953028c2435fc97dd))
* show sidebar in admin interface on mobile viewport ([#1320](https://github.com/Primitiv0/seatsurfing/issues/1320)) ([f8de296](https://github.com/Primitiv0/seatsurfing/commit/f8de296dc3c7823103f7ba48cb5eda5abf5eee94))
* split service accounts into read-only and read-write ([#936](https://github.com/Primitiv0/seatsurfing/issues/936)) ([68f2d79](https://github.com/Primitiv0/seatsurfing/commit/68f2d79956cfb303ae7cebc466282df4944da6ed))
* static web exports ([#983](https://github.com/Primitiv0/seatsurfing/issues/983)) ([c735f62](https://github.com/Primitiv0/seatsurfing/commit/c735f623f1c62e45e9a0c30de1521e0058dc3c71))
* support caching via Valkey.io ([#996](https://github.com/Primitiv0/seatsurfing/issues/996)) ([52e01d3](https://github.com/Primitiv0/seatsurfing/commit/52e01d35c7b4ed11f74d7b71fac33cd5a54fb1a2))
* use custom DNS resolver in domain accessibility verification http client ([#1125](https://github.com/Primitiv0/seatsurfing/issues/1125)) ([c76fa86](https://github.com/Primitiv0/seatsurfing/commit/c76fa86d8080ddd96129a0d43792dabc21f8b04c))


### Bug Fixes

* add auth provider template for Okta ([#689](https://github.com/Primitiv0/seatsurfing/issues/689)) ([ea7410c](https://github.com/Primitiv0/seatsurfing/commit/ea7410cd67cc3e058c5d38ac1bbf0edd940e1fe6))
* add error logging when generating access token failed ([#1278](https://github.com/Primitiv0/seatsurfing/issues/1278)) ([9ab4241](https://github.com/Primitiv0/seatsurfing/commit/9ab4241bf8925880c5f245405cbf8de62fa3bcae))
* add method for selecting orgs by signup date ([#1158](https://github.com/Primitiv0/seatsurfing/issues/1158)) ([c5d59cb](https://github.com/Primitiv0/seatsurfing/commit/c5d59cbc508569da09409fc60ba15d862de578d5))
* add missing error logging in organization router ([#1258](https://github.com/Primitiv0/seatsurfing/issues/1258)) ([327242c](https://github.com/Primitiv0/seatsurfing/commit/327242c9c88de114b0870e9a710687d1cdf7dc36))
* add missing German translations ([#1028](https://github.com/Primitiv0/seatsurfing/issues/1028)) ([5c6c3db](https://github.com/Primitiv0/seatsurfing/commit/5c6c3db6d53bc7c612e1a59f7acc99f5e2f87b90))
* add missing German translations ([#1245](https://github.com/Primitiv0/seatsurfing/issues/1245)) ([64fe53d](https://github.com/Primitiv0/seatsurfing/commit/64fe53ddaad23fbb8c6d5dfda565631c82ba5beb))
* add missing translations ([#699](https://github.com/Primitiv0/seatsurfing/issues/699)) ([067e3ed](https://github.com/Primitiv0/seatsurfing/commit/067e3eda7a9a9c74d4be893718316bdbfbcbcbb9))
* add missing version information ([#1008](https://github.com/Primitiv0/seatsurfing/issues/1008)) ([8603b3b](https://github.com/Primitiv0/seatsurfing/commit/8603b3b17efcc6b9ab4739f5db5c1ffb838e757f))
* add plugin init support ([#700](https://github.com/Primitiv0/seatsurfing/issues/700)) ([a26654f](https://github.com/Primitiv0/seatsurfing/commit/a26654f8ff215e354cd3944bc863a51c5ed4661e))
* add Portuguese translations ([#1192](https://github.com/Primitiv0/seatsurfing/issues/1192)) ([001d797](https://github.com/Primitiv0/seatsurfing/commit/001d7972e6ea27b76c4f8c0d961bad2085ae4655))
* add reason and error details to login failed URL ([#1259](https://github.com/Primitiv0/seatsurfing/issues/1259)) ([8608f73](https://github.com/Primitiv0/seatsurfing/commit/8608f7349a195eaa7a7dc7bfc1f59db14aa2bacb))
* add welcome screen support to admin ui ([#796](https://github.com/Primitiv0/seatsurfing/issues/796)) ([acf5c6b](https://github.com/Primitiv0/seatsurfing/commit/acf5c6bb5f5a64fd339b2ebdf51aaf7d4c9df01d))
* align error message in search widget (Booking UI) ([#769](https://github.com/Primitiv0/seatsurfing/issues/769)) ([92dcfbc](https://github.com/Primitiv0/seatsurfing/commit/92dcfbc8a7bd4de66d65e4eecc9b8df5684359d9))
* allow admin welcome screen skipping ([#823](https://github.com/Primitiv0/seatsurfing/issues/823)) ([62148f9](https://github.com/Primitiv0/seatsurfing/commit/62148f9159d1943f9d8055133256f08a622d1f9c))
* allow images via https in booking ui in order to show custom logos ([#1132](https://github.com/Primitiv0/seatsurfing/issues/1132)) ([fb8ce27](https://github.com/Primitiv0/seatsurfing/commit/fb8ce27c2b91dc75fce9bb3679184375de0e4f62))
* allow switchting between iFrames ([#945](https://github.com/Primitiv0/seatsurfing/issues/945)) ([fe4e639](https://github.com/Primitiv0/seatsurfing/commit/fe4e6399c790a07d92996c5380a7bab2f6eb78eb))
* changed several read-only endpoints to GET ([#934](https://github.com/Primitiv0/seatsurfing/issues/934)) ([7d2a150](https://github.com/Primitiv0/seatsurfing/commit/7d2a1508992f6b5083c674790e6e6e6c041b3311))
* check feature flag when creating an auth provider ([#863](https://github.com/Primitiv0/seatsurfing/issues/863)) ([93afe03](https://github.com/Primitiv0/seatsurfing/commit/93afe03da0a85b75d098d24dc180b8dc9c346db5))
* check for empty UUID in /auth/verify ([#892](https://github.com/Primitiv0/seatsurfing/issues/892)) ([d1d9e14](https://github.com/Primitiv0/seatsurfing/commit/d1d9e1410fafd6a0b149c744eaedae1ea772cb09))
* **deps:** bump @playwright/test from 1.51.0 to 1.51.1 in /e2e ([#681](https://github.com/Primitiv0/seatsurfing/issues/681)) ([4e48cef](https://github.com/Primitiv0/seatsurfing/commit/4e48cef97e2b42b7d5af92cf91a1c19e2620817d))
* **deps:** bump @playwright/test from 1.51.1 to 1.52.0 in /e2e ([#793](https://github.com/Primitiv0/seatsurfing/issues/793)) ([11298a3](https://github.com/Primitiv0/seatsurfing/commit/11298a38e27e047620e277686b0e58fae3e1c0dc))
* **deps:** bump @playwright/test from 1.53.1 to 1.53.2 in /e2e ([#1035](https://github.com/Primitiv0/seatsurfing/issues/1035)) ([1113653](https://github.com/Primitiv0/seatsurfing/commit/1113653602553e01a4cd0b2bda4e318a5cb1d402))
* **deps:** bump @playwright/test from 1.53.2 to 1.54.1 in /e2e ([#1068](https://github.com/Primitiv0/seatsurfing/issues/1068)) ([c56ba61](https://github.com/Primitiv0/seatsurfing/commit/c56ba61dfed6c5e3b3699e4bd382b58fe8de487a))
* **deps:** bump @playwright/test from 1.54.1 to 1.54.2 in /e2e ([#1144](https://github.com/Primitiv0/seatsurfing/issues/1144)) ([9e6e731](https://github.com/Primitiv0/seatsurfing/commit/9e6e731bb7bb9e0f41f4b6f141d3425ec60fc144))
* **deps:** bump @playwright/test from 1.54.2 to 1.55.0 in /e2e ([#1204](https://github.com/Primitiv0/seatsurfing/issues/1204)) ([0726e2c](https://github.com/Primitiv0/seatsurfing/commit/0726e2ccc3a66d7503cb8f28a4be9cdcf8bad9bf))
* **deps:** bump @playwright/test from 1.55.0 to 1.55.1 in /e2e ([#1315](https://github.com/Primitiv0/seatsurfing/issues/1315)) ([eca2b7c](https://github.com/Primitiv0/seatsurfing/commit/eca2b7c42dff57d45a7ae3cfabff1536d4ffe0ec))
* **deps:** bump @playwright/test to 1.53.1 ([#988](https://github.com/Primitiv0/seatsurfing/issues/988)) ([9773e16](https://github.com/Primitiv0/seatsurfing/commit/9773e1677b6f540aa0812f9ba63cc1932ea0104b))
* **deps:** bump @types/node from 22.13.10 to 22.13.11 in /admin-ui ([#692](https://github.com/Primitiv0/seatsurfing/issues/692)) ([1f247db](https://github.com/Primitiv0/seatsurfing/commit/1f247db4ba425ff4873ea2c6cb5edeb9cce2b205))
* **deps:** bump @types/node from 22.13.10 to 22.13.11 in /booking-ui ([#693](https://github.com/Primitiv0/seatsurfing/issues/693)) ([6c112ed](https://github.com/Primitiv0/seatsurfing/commit/6c112ed48512206bd903d18ee6c26588d91b4468))
* **deps:** bump @types/node from 22.13.10 to 22.13.11 in /e2e ([#694](https://github.com/Primitiv0/seatsurfing/issues/694)) ([c34f392](https://github.com/Primitiv0/seatsurfing/commit/c34f39261475f6f58740f9ef6bb46d56c4515700))
* **deps:** bump @types/node from 22.13.11 to 22.13.13 in /admin-ui ([#709](https://github.com/Primitiv0/seatsurfing/issues/709)) ([b1c3c50](https://github.com/Primitiv0/seatsurfing/commit/b1c3c504995125acca696330ae0dbe3012c1a751))
* **deps:** bump @types/node from 22.13.11 to 22.13.13 in /booking-ui ([#710](https://github.com/Primitiv0/seatsurfing/issues/710)) ([cf0df3c](https://github.com/Primitiv0/seatsurfing/commit/cf0df3c9b58198ad5392d195880e57db76455ace))
* **deps:** bump @types/node from 22.13.11 to 22.13.13 in /e2e ([#712](https://github.com/Primitiv0/seatsurfing/issues/712)) ([5d6e10a](https://github.com/Primitiv0/seatsurfing/commit/5d6e10a4f7976831a4f30e666a72f7c58aff32b8))
* **deps:** bump @types/node from 22.13.13 to 22.14.0 in /admin-ui ([#747](https://github.com/Primitiv0/seatsurfing/issues/747)) ([ca318ce](https://github.com/Primitiv0/seatsurfing/commit/ca318ce57b11dbf35c12d38d63ca659d09e1b9b5))
* **deps:** bump @types/node from 22.13.13 to 22.14.0 in /booking-ui ([#750](https://github.com/Primitiv0/seatsurfing/issues/750)) ([e0d8a6c](https://github.com/Primitiv0/seatsurfing/commit/e0d8a6c8851b6ed16f3d95dd51c2203fc32d2448))
* **deps:** bump @types/node from 22.13.13 to 22.14.0 in /e2e ([#751](https://github.com/Primitiv0/seatsurfing/issues/751)) ([41d4275](https://github.com/Primitiv0/seatsurfing/commit/41d4275312d1f97b3f46fba51c6eaf3865c6f31b))
* **deps:** bump @types/node from 22.14.0 to 22.14.1 in /admin-ui ([#780](https://github.com/Primitiv0/seatsurfing/issues/780)) ([26e2e45](https://github.com/Primitiv0/seatsurfing/commit/26e2e453f1e53caa491260780693e6266acb2dc9))
* **deps:** bump @types/node from 22.14.0 to 22.14.1 in /booking-ui ([#781](https://github.com/Primitiv0/seatsurfing/issues/781)) ([6b1beaa](https://github.com/Primitiv0/seatsurfing/commit/6b1beaabadefee903a543afd2df6563859015286))
* **deps:** bump @types/node from 22.14.0 to 22.14.1 in /e2e ([#782](https://github.com/Primitiv0/seatsurfing/issues/782)) ([46f2302](https://github.com/Primitiv0/seatsurfing/commit/46f23025773826ab4af4ad00db0d8e72eb3c8a78))
* **deps:** bump @types/node from 22.14.1 to 22.15.3 in /admin-ui ([#816](https://github.com/Primitiv0/seatsurfing/issues/816)) ([b884d8d](https://github.com/Primitiv0/seatsurfing/commit/b884d8d3a99e3755b232065cf24f37b237f987f5))
* **deps:** bump @types/node from 22.14.1 to 22.15.3 in /booking-ui ([#814](https://github.com/Primitiv0/seatsurfing/issues/814)) ([2335ec2](https://github.com/Primitiv0/seatsurfing/commit/2335ec28eda0ecbdd93ac2ef58e89107ae47bfd1))
* **deps:** bump @types/node from 22.14.1 to 22.15.3 in /e2e ([#817](https://github.com/Primitiv0/seatsurfing/issues/817)) ([dac6200](https://github.com/Primitiv0/seatsurfing/commit/dac62008646d5dbba4ad9f41c44402a5bce91859))
* **deps:** bump @types/node from 22.15.17 to 22.15.18 in /admin-ui ([#860](https://github.com/Primitiv0/seatsurfing/issues/860)) ([fd6a19c](https://github.com/Primitiv0/seatsurfing/commit/fd6a19c2c419e17f300979526968137327abee81))
* **deps:** bump @types/node from 22.15.17 to 22.15.18 in /e2e ([#861](https://github.com/Primitiv0/seatsurfing/issues/861)) ([2c5bc97](https://github.com/Primitiv0/seatsurfing/commit/2c5bc97475857530c81a211767a5d53f9082ccfb))
* **deps:** bump @types/node from 22.15.18 to 22.15.21 in /admin-ui ([#889](https://github.com/Primitiv0/seatsurfing/issues/889)) ([5c94526](https://github.com/Primitiv0/seatsurfing/commit/5c94526d1fc7237f2ff00919c65eb3b12c6e8268))
* **deps:** bump @types/node from 22.15.18 to 22.15.21 in /booking-ui ([#890](https://github.com/Primitiv0/seatsurfing/issues/890)) ([afd4216](https://github.com/Primitiv0/seatsurfing/commit/afd42169d0181467d189c9d4689454ca2c29538b))
* **deps:** bump @types/node from 22.15.18 to 22.15.21 in /e2e ([#891](https://github.com/Primitiv0/seatsurfing/issues/891)) ([fc2e380](https://github.com/Primitiv0/seatsurfing/commit/fc2e38039843010328c106a52aeae1c4890c8384))
* **deps:** bump @types/node from 22.15.21 to 22.15.24 in /admin-ui ([#909](https://github.com/Primitiv0/seatsurfing/issues/909)) ([3e9c8f7](https://github.com/Primitiv0/seatsurfing/commit/3e9c8f75e95bb6cffbcddb55870e5c2009c2ff3f))
* **deps:** bump @types/node from 22.15.21 to 22.15.24 in /booking-ui ([#910](https://github.com/Primitiv0/seatsurfing/issues/910)) ([2c8ad06](https://github.com/Primitiv0/seatsurfing/commit/2c8ad0649af71ef806937ea65d91a0acf3e6d5b9))
* **deps:** bump @types/node from 22.15.21 to 22.15.24 in /e2e ([#911](https://github.com/Primitiv0/seatsurfing/issues/911)) ([8c085a9](https://github.com/Primitiv0/seatsurfing/commit/8c085a992afcca06769f497c940829b4881e3c47))
* **deps:** bump @types/node from 22.15.24 to 22.15.28 in /admin-ui ([#914](https://github.com/Primitiv0/seatsurfing/issues/914)) ([53dd296](https://github.com/Primitiv0/seatsurfing/commit/53dd29603a3fbdb7c49477cc18a0f2182b57db1b))
* **deps:** bump @types/node from 22.15.24 to 22.15.28 in /booking-ui ([#918](https://github.com/Primitiv0/seatsurfing/issues/918)) ([c20713e](https://github.com/Primitiv0/seatsurfing/commit/c20713e5c149de6bef541778f73d4d33194ecabe))
* **deps:** bump @types/node from 22.15.24 to 22.15.28 in /e2e ([#920](https://github.com/Primitiv0/seatsurfing/issues/920)) ([061242e](https://github.com/Primitiv0/seatsurfing/commit/061242e7023945e7ece9d437bde44b79f12f6623))
* **deps:** bump @types/node from 22.15.28 to 22.15.29 in /admin-ui ([#929](https://github.com/Primitiv0/seatsurfing/issues/929)) ([d00fa5a](https://github.com/Primitiv0/seatsurfing/commit/d00fa5af5be0c5b14c1f61a87e96e30a5c800292))
* **deps:** bump @types/node from 22.15.28 to 22.15.29 in /booking-ui ([#928](https://github.com/Primitiv0/seatsurfing/issues/928)) ([47c8d51](https://github.com/Primitiv0/seatsurfing/commit/47c8d51a6e38f550dfdaa26be3b0d73527ce9923))
* **deps:** bump @types/node from 22.15.28 to 22.15.29 in /e2e ([#930](https://github.com/Primitiv0/seatsurfing/issues/930)) ([048902f](https://github.com/Primitiv0/seatsurfing/commit/048902f4a7efb081fa6bfea4c555f60f14b8d7e3))
* **deps:** bump @types/node from 22.15.29 to 22.15.30 in /admin-ui ([#938](https://github.com/Primitiv0/seatsurfing/issues/938)) ([64453aa](https://github.com/Primitiv0/seatsurfing/commit/64453aa5eacb600a460e2605c5122a08c705bca9))
* **deps:** bump @types/node from 22.15.29 to 22.15.30 in /e2e ([#939](https://github.com/Primitiv0/seatsurfing/issues/939)) ([4832495](https://github.com/Primitiv0/seatsurfing/commit/483249524853e64cf1af60ae43ee85e1252af482))
* **deps:** bump @types/node from 22.15.3 to 22.15.17 in /admin-ui ([#846](https://github.com/Primitiv0/seatsurfing/issues/846)) ([aede052](https://github.com/Primitiv0/seatsurfing/commit/aede052910ce0b002acc5de413f5975621368bf8))
* **deps:** bump @types/node from 22.15.3 to 22.15.17 in /booking-ui ([#848](https://github.com/Primitiv0/seatsurfing/issues/848)) ([9821513](https://github.com/Primitiv0/seatsurfing/commit/9821513c74a952c2614f9df0351a67e6c6baa89b))
* **deps:** bump @types/node from 22.15.3 to 22.15.17 in /e2e ([#849](https://github.com/Primitiv0/seatsurfing/issues/849)) ([907ba87](https://github.com/Primitiv0/seatsurfing/commit/907ba87ba609580c1e54b4bbf8b80ba404976efb))
* **deps:** bump @types/node from 22.15.30 to 24.0.1 in /admin-ui ([#962](https://github.com/Primitiv0/seatsurfing/issues/962)) ([1147e82](https://github.com/Primitiv0/seatsurfing/commit/1147e82849861be68c9490a43d494d48a0f34a56))
* **deps:** bump @types/node from 22.15.30 to 24.0.1 in /booking-ui ([#963](https://github.com/Primitiv0/seatsurfing/issues/963)) ([062ec84](https://github.com/Primitiv0/seatsurfing/commit/062ec844309aac0a2738bded6d2e93fdb63e07d1))
* **deps:** bump @types/node from 22.15.30 to 24.0.1 in /e2e ([#965](https://github.com/Primitiv0/seatsurfing/issues/965)) ([a6dab6a](https://github.com/Primitiv0/seatsurfing/commit/a6dab6aac0de86b43efc387b2ad1ea97e19d8008))
* **deps:** bump @types/node from 24.0.1 to 24.0.3 in /admin-ui ([#972](https://github.com/Primitiv0/seatsurfing/issues/972)) ([328ec65](https://github.com/Primitiv0/seatsurfing/commit/328ec6598cb6d401c297afcc3cb23f00c9487cd1))
* **deps:** bump @types/node from 24.0.1 to 24.0.3 in /booking-ui ([#969](https://github.com/Primitiv0/seatsurfing/issues/969)) ([500ff84](https://github.com/Primitiv0/seatsurfing/commit/500ff842baa10a7a47f0310eabf72bb3f4bc5b49))
* **deps:** bump @types/node from 24.0.1 to 24.0.3 in /e2e ([#970](https://github.com/Primitiv0/seatsurfing/issues/970)) ([fd47c27](https://github.com/Primitiv0/seatsurfing/commit/fd47c270ede7be984466555692205343ebb18ca2))
* **deps:** bump @types/node from 24.0.12 to 24.0.13 in /admin-ui ([#1065](https://github.com/Primitiv0/seatsurfing/issues/1065)) ([93b5718](https://github.com/Primitiv0/seatsurfing/commit/93b57185fb97d935dd9716bc2164afd2179f08d1))
* **deps:** bump @types/node from 24.0.12 to 24.0.13 in /booking-ui ([#1066](https://github.com/Primitiv0/seatsurfing/issues/1066)) ([98586b3](https://github.com/Primitiv0/seatsurfing/commit/98586b3cd0f8a0e6fcf0dfebc5ab9ec783626920))
* **deps:** bump @types/node from 24.0.12 to 24.0.13 in /e2e ([#1067](https://github.com/Primitiv0/seatsurfing/issues/1067)) ([9d26b39](https://github.com/Primitiv0/seatsurfing/commit/9d26b397b602321d09e2eecbecf3d08618ffe74c))
* **deps:** bump @types/node from 24.0.13 to 24.0.14 in /admin-ui ([#1081](https://github.com/Primitiv0/seatsurfing/issues/1081)) ([25cc5d0](https://github.com/Primitiv0/seatsurfing/commit/25cc5d04be9d4f3722bfe230a35513db0e7a4f41))
* **deps:** bump @types/node from 24.0.13 to 24.0.14 in /booking-ui ([#1082](https://github.com/Primitiv0/seatsurfing/issues/1082)) ([b9f3b84](https://github.com/Primitiv0/seatsurfing/commit/b9f3b84caf35443a9ce200bf837920e99a0d99f1))
* **deps:** bump @types/node from 24.0.13 to 24.0.14 in /e2e ([#1085](https://github.com/Primitiv0/seatsurfing/issues/1085)) ([9834c76](https://github.com/Primitiv0/seatsurfing/commit/9834c769cfbf0999adeef80a5db5f9b0a5c904de))
* **deps:** bump @types/node from 24.0.14 to 24.0.15 in /admin-ui ([#1097](https://github.com/Primitiv0/seatsurfing/issues/1097)) ([4889541](https://github.com/Primitiv0/seatsurfing/commit/48895412a9051eaa24d0d2c5d778953c07b0e9da))
* **deps:** bump @types/node from 24.0.14 to 24.0.15 in /booking-ui ([#1101](https://github.com/Primitiv0/seatsurfing/issues/1101)) ([0880e46](https://github.com/Primitiv0/seatsurfing/commit/0880e46cea90e6a5fbeb7bc7bca0c4b13ce4c237))
* **deps:** bump @types/node from 24.0.14 to 24.0.15 in /e2e ([#1102](https://github.com/Primitiv0/seatsurfing/issues/1102)) ([49576aa](https://github.com/Primitiv0/seatsurfing/commit/49576aa973cf6d6c6b5a5b54e5e797e2dd22012d))
* **deps:** bump @types/node from 24.0.15 to 24.1.0 in /admin-ui ([#1104](https://github.com/Primitiv0/seatsurfing/issues/1104)) ([19522e6](https://github.com/Primitiv0/seatsurfing/commit/19522e6fae7ef81c3ee2e26e70bb6aec19004f94))
* **deps:** bump @types/node from 24.0.15 to 24.1.0 in /booking-ui ([#1105](https://github.com/Primitiv0/seatsurfing/issues/1105)) ([4c2d847](https://github.com/Primitiv0/seatsurfing/commit/4c2d84730489ca38569d72d33a73af08a802edb2))
* **deps:** bump @types/node from 24.0.15 to 24.1.0 in /e2e ([#1106](https://github.com/Primitiv0/seatsurfing/issues/1106)) ([a95d46a](https://github.com/Primitiv0/seatsurfing/commit/a95d46ac145fcff4fad8035ba3ec25b334349609))
* **deps:** bump @types/node from 24.0.3 to 24.0.4 in /admin-ui ([#1015](https://github.com/Primitiv0/seatsurfing/issues/1015)) ([b4c36c1](https://github.com/Primitiv0/seatsurfing/commit/b4c36c12b64b21e13d2d365ac8101bdb718a865d))
* **deps:** bump @types/node from 24.0.3 to 24.0.4 in /booking-ui ([#1016](https://github.com/Primitiv0/seatsurfing/issues/1016)) ([a918273](https://github.com/Primitiv0/seatsurfing/commit/a9182739f0dcb1041f13aaf2f4b02d70fecc85c8))
* **deps:** bump @types/node from 24.0.3 to 24.0.4 in /e2e ([#1017](https://github.com/Primitiv0/seatsurfing/issues/1017)) ([f1c3f93](https://github.com/Primitiv0/seatsurfing/commit/f1c3f93ef224fcda6624df4f3e175d12e1ba0c30))
* **deps:** bump @types/node from 24.0.4 to 24.0.5 in /admin-ui ([#1022](https://github.com/Primitiv0/seatsurfing/issues/1022)) ([ec18a16](https://github.com/Primitiv0/seatsurfing/commit/ec18a162e218a9d3ac32dd760caf51b3f8b1d8fc))
* **deps:** bump @types/node from 24.0.4 to 24.0.5 in /booking-ui ([#1023](https://github.com/Primitiv0/seatsurfing/issues/1023)) ([3cb1ebc](https://github.com/Primitiv0/seatsurfing/commit/3cb1ebc38c5c6d0c79097b80a8651d21696ec741))
* **deps:** bump @types/node from 24.0.4 to 24.0.5 in /e2e ([#1024](https://github.com/Primitiv0/seatsurfing/issues/1024)) ([96fc6d2](https://github.com/Primitiv0/seatsurfing/commit/96fc6d2400e7a1858e219d301e8cc6ce7547c762))
* **deps:** bump @types/node from 24.0.7 to 24.0.12 in /admin-ui ([#1060](https://github.com/Primitiv0/seatsurfing/issues/1060)) ([fbafd4c](https://github.com/Primitiv0/seatsurfing/commit/fbafd4cb73462125d87f81045e8a3d57d70c3bc4))
* **deps:** bump @types/node from 24.0.7 to 24.0.12 in /booking-ui ([#1061](https://github.com/Primitiv0/seatsurfing/issues/1061)) ([9dc94f3](https://github.com/Primitiv0/seatsurfing/commit/9dc94f34cd775a49b37c56b21a134a923796fd52))
* **deps:** bump @types/node from 24.0.7 to 24.0.12 in /e2e ([#1062](https://github.com/Primitiv0/seatsurfing/issues/1062)) ([754702d](https://github.com/Primitiv0/seatsurfing/commit/754702de90d69aed2114496988cd60845826ff9a))
* **deps:** bump @types/node from 24.1.0 to 24.2.0 in /admin-ui ([#1150](https://github.com/Primitiv0/seatsurfing/issues/1150)) ([3ef1eb6](https://github.com/Primitiv0/seatsurfing/commit/3ef1eb6cbb18bf04332c56e9123b91ebdc4fce36))
* **deps:** bump @types/node from 24.1.0 to 24.2.0 in /booking-ui ([#1149](https://github.com/Primitiv0/seatsurfing/issues/1149)) ([aecfc37](https://github.com/Primitiv0/seatsurfing/commit/aecfc37e4c7a3759d1720450dbfa81628643f872))
* **deps:** bump @types/node from 24.1.0 to 24.2.0 in /e2e ([#1151](https://github.com/Primitiv0/seatsurfing/issues/1151)) ([c77a581](https://github.com/Primitiv0/seatsurfing/commit/c77a58107a10c1e82dc7143a1e8f160a4af64615))
* **deps:** bump @types/node from 24.2.0 to 24.2.1 in /admin-ui ([#1171](https://github.com/Primitiv0/seatsurfing/issues/1171)) ([d0f1aec](https://github.com/Primitiv0/seatsurfing/commit/d0f1aecf5414d86661b079207464902c766178c8))
* **deps:** bump @types/node from 24.2.0 to 24.2.1 in /booking-ui ([#1172](https://github.com/Primitiv0/seatsurfing/issues/1172)) ([f92eb79](https://github.com/Primitiv0/seatsurfing/commit/f92eb79746513bf358ba94f46d14c679b8d113c2))
* **deps:** bump @types/node from 24.2.0 to 24.2.1 in /e2e ([#1173](https://github.com/Primitiv0/seatsurfing/issues/1173)) ([b3f344c](https://github.com/Primitiv0/seatsurfing/commit/b3f344cb53030e176e0e345e7914fc69fcca97d1))
* **deps:** bump @types/node from 24.2.1 to 24.3.0 in /admin-ui ([#1184](https://github.com/Primitiv0/seatsurfing/issues/1184)) ([1b100ed](https://github.com/Primitiv0/seatsurfing/commit/1b100ed979a1e151620ef4335f32f60f86543ab2))
* **deps:** bump @types/node from 24.2.1 to 24.3.0 in /booking-ui ([#1185](https://github.com/Primitiv0/seatsurfing/issues/1185)) ([719aaab](https://github.com/Primitiv0/seatsurfing/commit/719aaabe073e316b5e61ff8e4f519193dd734262))
* **deps:** bump @types/node from 24.2.1 to 24.3.0 in /e2e ([#1186](https://github.com/Primitiv0/seatsurfing/issues/1186)) ([5566e65](https://github.com/Primitiv0/seatsurfing/commit/5566e65cebf7ebbc9d35692840138992c0ca2859))
* **deps:** bump @types/node from 24.3.0 to 24.3.1 in /admin-ui ([#1239](https://github.com/Primitiv0/seatsurfing/issues/1239)) ([90b18e2](https://github.com/Primitiv0/seatsurfing/commit/90b18e22165033a2b74167ee3e5538cfe38a9c2d))
* **deps:** bump @types/node from 24.3.0 to 24.3.1 in /booking-ui ([#1240](https://github.com/Primitiv0/seatsurfing/issues/1240)) ([15b8140](https://github.com/Primitiv0/seatsurfing/commit/15b8140934e17d7f133c0d7775b7bd3d166e2606))
* **deps:** bump @types/node from 24.3.0 to 24.3.1 in /e2e ([#1241](https://github.com/Primitiv0/seatsurfing/issues/1241)) ([b2aac50](https://github.com/Primitiv0/seatsurfing/commit/b2aac5000d83a1a1d431007c32ca3749bc9cbb1b))
* **deps:** bump @types/node from 24.3.1 to 24.5.2 in /admin-ui ([#1303](https://github.com/Primitiv0/seatsurfing/issues/1303)) ([57bf92f](https://github.com/Primitiv0/seatsurfing/commit/57bf92ff53baf1ec26f58a514e97c595f6942d63))
* **deps:** bump @types/node from 24.3.1 to 24.5.2 in /booking-ui ([#1304](https://github.com/Primitiv0/seatsurfing/issues/1304)) ([4e7d627](https://github.com/Primitiv0/seatsurfing/commit/4e7d6273865b2c6247d6502d870ccf4c11739014))
* **deps:** bump @types/node from 24.3.1 to 24.5.2 in /e2e ([#1305](https://github.com/Primitiv0/seatsurfing/issues/1305)) ([f90de15](https://github.com/Primitiv0/seatsurfing/commit/f90de158aca023b53d75525e051910c82d6278b9))
* **deps:** bump @types/react-dom from 19.0.4 to 19.1.1 in /admin-ui ([#748](https://github.com/Primitiv0/seatsurfing/issues/748)) ([75c14cd](https://github.com/Primitiv0/seatsurfing/commit/75c14cdf3d6da4046b02878765cedc413fa7a7a6))
* **deps:** bump @types/react-dom from 19.0.4 to 19.1.1 in /booking-ui ([#749](https://github.com/Primitiv0/seatsurfing/issues/749)) ([19f1345](https://github.com/Primitiv0/seatsurfing/commit/19f13456af5ceea712352251f202a5c8402bd170))
* **deps:** bump @types/react-dom from 19.1.1 to 19.1.2 in /admin-ui ([#771](https://github.com/Primitiv0/seatsurfing/issues/771)) ([6b90a19](https://github.com/Primitiv0/seatsurfing/commit/6b90a19b76214459a9990034a8d41a1f4aa5f11c))
* **deps:** bump @types/react-dom from 19.1.1 to 19.1.2 in /booking-ui ([#776](https://github.com/Primitiv0/seatsurfing/issues/776)) ([5312e0a](https://github.com/Primitiv0/seatsurfing/commit/5312e0a44b39702bfd03133f6e3960555180bae5))
* **deps:** bump @types/react-dom from 19.1.2 to 19.1.3 in /admin-ui ([#821](https://github.com/Primitiv0/seatsurfing/issues/821)) ([c47595f](https://github.com/Primitiv0/seatsurfing/commit/c47595f7dca85e6142f273afda30df9ca83bd68d))
* **deps:** bump @types/react-dom from 19.1.2 to 19.1.3 in /booking-ui ([#822](https://github.com/Primitiv0/seatsurfing/issues/822)) ([de06610](https://github.com/Primitiv0/seatsurfing/commit/de06610f2ca8b777b6f0c0dac321a8fc0ab4ba67))
* **deps:** bump @types/react-dom from 19.1.3 to 19.1.5 in /admin-ui ([#858](https://github.com/Primitiv0/seatsurfing/issues/858)) ([0426826](https://github.com/Primitiv0/seatsurfing/commit/042682617ba10020a59596f4e17116dc4fe211d4))
* **deps:** bump @types/react-dom from 19.1.3 to 19.1.5 in /booking-ui ([#859](https://github.com/Primitiv0/seatsurfing/issues/859)) ([ab13e85](https://github.com/Primitiv0/seatsurfing/commit/ab13e8522ed417aa37810c5a725753ba2a6f0709))
* **deps:** bump @types/react-dom from 19.1.5 to 19.1.6 in /admin-ui ([#932](https://github.com/Primitiv0/seatsurfing/issues/932)) ([212b1e8](https://github.com/Primitiv0/seatsurfing/commit/212b1e81cd90cccd2f17a0a0dbb86d75e9f4ecd6))
* **deps:** bump @types/react-dom from 19.1.5 to 19.1.6 in /booking-ui ([#933](https://github.com/Primitiv0/seatsurfing/issues/933)) ([77e6184](https://github.com/Primitiv0/seatsurfing/commit/77e6184a031057c2bc5eafef96c7c7a47a9989f7))
* **deps:** bump @types/react-dom from 19.1.6 to 19.1.7 in /admin-ui ([#1133](https://github.com/Primitiv0/seatsurfing/issues/1133)) ([a1e2548](https://github.com/Primitiv0/seatsurfing/commit/a1e2548d37f927c414f8f1cd90d88183d911c68a))
* **deps:** bump @types/react-dom from 19.1.6 to 19.1.7 in /booking-ui ([#1134](https://github.com/Primitiv0/seatsurfing/issues/1134)) ([9b8a2bd](https://github.com/Primitiv0/seatsurfing/commit/9b8a2bd592886052a4f0e73e2322a61a7b9fc4e3))
* **deps:** bump @types/react-dom from 19.1.7 to 19.1.9 in /admin-ui ([#1229](https://github.com/Primitiv0/seatsurfing/issues/1229)) ([41406a1](https://github.com/Primitiv0/seatsurfing/commit/41406a17ccc4700171bfb5886d3beb5587a42005))
* **deps:** bump @types/react-dom from 19.1.7 to 19.1.9 in /booking-ui ([#1230](https://github.com/Primitiv0/seatsurfing/issues/1230)) ([3ea4477](https://github.com/Primitiv0/seatsurfing/commit/3ea4477350941176a24785dc56191877491bc5fc))
* **deps:** bump bootstrap from 5.3.3 to 5.3.5 in /admin-ui ([#756](https://github.com/Primitiv0/seatsurfing/issues/756)) ([ef0b727](https://github.com/Primitiv0/seatsurfing/commit/ef0b72725e87b021e14db5f591d440b580770bc9))
* **deps:** bump bootstrap from 5.3.3 to 5.3.5 in /booking-ui ([#757](https://github.com/Primitiv0/seatsurfing/issues/757)) ([ed14a7b](https://github.com/Primitiv0/seatsurfing/commit/ed14a7b2d791242543a797234df6b3e0a534deeb))
* **deps:** bump bootstrap from 5.3.5 to 5.3.6 in /admin-ui ([#832](https://github.com/Primitiv0/seatsurfing/issues/832)) ([891d4b3](https://github.com/Primitiv0/seatsurfing/commit/891d4b32c434c7448ab8aeaba33c2d9d9ef00378))
* **deps:** bump bootstrap from 5.3.5 to 5.3.6 in /booking-ui ([#835](https://github.com/Primitiv0/seatsurfing/issues/835)) ([5bbd5b8](https://github.com/Primitiv0/seatsurfing/commit/5bbd5b88a4bc749b2f5bf25fd0a2b657c0054d24))
* **deps:** bump bootstrap from 5.3.6 to 5.3.7 in /admin-ui ([#973](https://github.com/Primitiv0/seatsurfing/issues/973)) ([94d37ed](https://github.com/Primitiv0/seatsurfing/commit/94d37edd2afaf9487cab900882e10c61ad5d6991))
* **deps:** bump bootstrap from 5.3.6 to 5.3.7 in /booking-ui ([#974](https://github.com/Primitiv0/seatsurfing/issues/974)) ([2b4be7e](https://github.com/Primitiv0/seatsurfing/commit/2b4be7ed648365c8b25fe8d48985218e63ae6feb))
* **deps:** bump bootstrap from 5.3.7 to 5.3.8 in /admin-ui ([#1220](https://github.com/Primitiv0/seatsurfing/issues/1220)) ([05c6f86](https://github.com/Primitiv0/seatsurfing/commit/05c6f8608133510ff2dfcb121b543578a4d0e405))
* **deps:** bump bootstrap from 5.3.7 to 5.3.8 in /booking-ui ([#1221](https://github.com/Primitiv0/seatsurfing/issues/1221)) ([f8c1174](https://github.com/Primitiv0/seatsurfing/commit/f8c117457c7bd7d12a8c7a175bf487c9dfc9edbe))
* **deps:** bump eslint from 9.22.0 to 9.23.0 in /admin-ui ([#711](https://github.com/Primitiv0/seatsurfing/issues/711)) ([2a857d1](https://github.com/Primitiv0/seatsurfing/commit/2a857d12184fe66547d0950e760af0cf374307e3))
* **deps:** bump eslint from 9.22.0 to 9.23.0 in /booking-ui ([#713](https://github.com/Primitiv0/seatsurfing/issues/713)) ([dee7a19](https://github.com/Primitiv0/seatsurfing/commit/dee7a1994e44019edea4a84fc781810f5d021ce6))
* **deps:** bump eslint from 9.23.0 to 9.24.0 in /admin-ui ([#766](https://github.com/Primitiv0/seatsurfing/issues/766)) ([5614f75](https://github.com/Primitiv0/seatsurfing/commit/5614f75748bffdb1d9b216390b7cbc8226470fb8))
* **deps:** bump eslint from 9.23.0 to 9.24.0 in /booking-ui ([#764](https://github.com/Primitiv0/seatsurfing/issues/764)) ([792d69e](https://github.com/Primitiv0/seatsurfing/commit/792d69eace706a99942fcd48d05699afa926c921))
* **deps:** bump eslint from 9.24.0 to 9.25.1 in /admin-ui ([#800](https://github.com/Primitiv0/seatsurfing/issues/800)) ([7bcc12a](https://github.com/Primitiv0/seatsurfing/commit/7bcc12a66aabcb0b6ddc5549c10669822ea9cf99))
* **deps:** bump eslint from 9.24.0 to 9.25.1 in /booking-ui ([#802](https://github.com/Primitiv0/seatsurfing/issues/802)) ([c144f37](https://github.com/Primitiv0/seatsurfing/commit/c144f3722207e42c463ba64151edbab9c777bd4d))
* **deps:** bump eslint from 9.25.1 to 9.26.0 in /admin-ui ([#831](https://github.com/Primitiv0/seatsurfing/issues/831)) ([13fa44e](https://github.com/Primitiv0/seatsurfing/commit/13fa44eb56fa79a7c5f8b23b267b03de93f710c9))
* **deps:** bump eslint from 9.25.1 to 9.26.0 in /booking-ui ([#830](https://github.com/Primitiv0/seatsurfing/issues/830)) ([5c50b40](https://github.com/Primitiv0/seatsurfing/commit/5c50b400b0c55a1d1df707b2beebfb3d6c858646))
* **deps:** bump eslint from 9.26.0 to 9.27.0 in /admin-ui ([#875](https://github.com/Primitiv0/seatsurfing/issues/875)) ([d1cdc2b](https://github.com/Primitiv0/seatsurfing/commit/d1cdc2b81a1e941f70fda9bdff5a5fa42c0ee6a6))
* **deps:** bump eslint from 9.26.0 to 9.27.0 in /booking-ui ([#880](https://github.com/Primitiv0/seatsurfing/issues/880)) ([ee9b7b7](https://github.com/Primitiv0/seatsurfing/commit/ee9b7b75cd85e4e665c0af6f3600016a07657908))
* **deps:** bump eslint from 9.27.0 to 9.28.0 in /admin-ui ([#925](https://github.com/Primitiv0/seatsurfing/issues/925)) ([b014d6b](https://github.com/Primitiv0/seatsurfing/commit/b014d6b3034a8164b4977948bdf7c16227baedc4))
* **deps:** bump eslint from 9.27.0 to 9.28.0 in /booking-ui ([#926](https://github.com/Primitiv0/seatsurfing/issues/926)) ([6b8614d](https://github.com/Primitiv0/seatsurfing/commit/6b8614ddac4829de09b9013225ec1bbcfed70233))
* **deps:** bump eslint from 9.28.0 to 9.29.0 in /admin-ui ([#966](https://github.com/Primitiv0/seatsurfing/issues/966)) ([bae4219](https://github.com/Primitiv0/seatsurfing/commit/bae421935c0e359922380ad09129831b7d42fd25))
* **deps:** bump eslint from 9.28.0 to 9.29.0 in /booking-ui ([#967](https://github.com/Primitiv0/seatsurfing/issues/967)) ([42e05b3](https://github.com/Primitiv0/seatsurfing/commit/42e05b3f5a68846f19fe4eadc83ba2f00d4a3e5f))
* **deps:** bump eslint from 9.29.0 to 9.30.1 in /admin-ui ([#1041](https://github.com/Primitiv0/seatsurfing/issues/1041)) ([dcaa712](https://github.com/Primitiv0/seatsurfing/commit/dcaa7129b0247c4fab371bca78315d19b77b98c3))
* **deps:** bump eslint from 9.29.0 to 9.30.1 in /booking-ui ([#1043](https://github.com/Primitiv0/seatsurfing/issues/1043)) ([eabecf8](https://github.com/Primitiv0/seatsurfing/commit/eabecf88bf5688c4930a9873ebf422115f3bf3f8))
* **deps:** bump eslint from 9.30.1 to 9.31.0 in /admin-ui ([#1078](https://github.com/Primitiv0/seatsurfing/issues/1078)) ([130486c](https://github.com/Primitiv0/seatsurfing/commit/130486c30729e9f9258632475a820af2ff30f2ab))
* **deps:** bump eslint from 9.30.1 to 9.31.0 in /booking-ui ([#1077](https://github.com/Primitiv0/seatsurfing/issues/1077)) ([8b778d7](https://github.com/Primitiv0/seatsurfing/commit/8b778d75044a8961d45e14115042998c094b0dfb))
* **deps:** bump eslint from 9.31.0 to 9.32.0 in /admin-ui ([#1118](https://github.com/Primitiv0/seatsurfing/issues/1118)) ([c0d9f19](https://github.com/Primitiv0/seatsurfing/commit/c0d9f196fbaacc7a5bc57706027ef6170945926c))
* **deps:** bump eslint from 9.31.0 to 9.32.0 in /booking-ui ([#1122](https://github.com/Primitiv0/seatsurfing/issues/1122)) ([13f7ab1](https://github.com/Primitiv0/seatsurfing/commit/13f7ab11d2543d00b6b605fe5d2a1a7270bfb6b7))
* **deps:** bump eslint from 9.32.0 to 9.33.0 in /admin-ui ([#1179](https://github.com/Primitiv0/seatsurfing/issues/1179)) ([f3037c6](https://github.com/Primitiv0/seatsurfing/commit/f3037c68b2982fb84b5665241897a808bb251896))
* **deps:** bump eslint from 9.32.0 to 9.33.0 in /booking-ui ([#1180](https://github.com/Primitiv0/seatsurfing/issues/1180)) ([880f543](https://github.com/Primitiv0/seatsurfing/commit/880f543246c1a1f8662e16f01b4584a5e5477cb3))
* **deps:** bump eslint from 9.33.0 to 9.34.0 in /admin-ui ([#1216](https://github.com/Primitiv0/seatsurfing/issues/1216)) ([259be02](https://github.com/Primitiv0/seatsurfing/commit/259be02070d288afc4af55faa80650167d96c1af))
* **deps:** bump eslint from 9.33.0 to 9.34.0 in /booking-ui ([#1215](https://github.com/Primitiv0/seatsurfing/issues/1215)) ([41a1918](https://github.com/Primitiv0/seatsurfing/commit/41a1918db963c9570caefac57098d0eb18f8426b))
* **deps:** bump eslint from 9.34.0 to 9.35.0 in /admin-ui ([#1247](https://github.com/Primitiv0/seatsurfing/issues/1247)) ([67f7e29](https://github.com/Primitiv0/seatsurfing/commit/67f7e29ebf6cc74f39b4618e9537eacfbeff6696))
* **deps:** bump eslint from 9.34.0 to 9.35.0 in /booking-ui ([#1248](https://github.com/Primitiv0/seatsurfing/issues/1248)) ([6203036](https://github.com/Primitiv0/seatsurfing/commit/62030367469ec9318121a90ff591fd4f5734a04a))
* **deps:** bump eslint from 9.35.0 to 9.36.0 in /admin-ui ([#1306](https://github.com/Primitiv0/seatsurfing/issues/1306)) ([5f9aec7](https://github.com/Primitiv0/seatsurfing/commit/5f9aec7b5adccef63d08a1ab7498bb66e8deaa67))
* **deps:** bump eslint from 9.35.0 to 9.36.0 in /booking-ui ([#1307](https://github.com/Primitiv0/seatsurfing/issues/1307)) ([2e0e6d1](https://github.com/Primitiv0/seatsurfing/commit/2e0e6d1edc5e78289c7ba84929d080505e0401e2))
* **deps:** bump eslint-config-next from 15.2.2 to 15.2.3 in /admin-ui ([#684](https://github.com/Primitiv0/seatsurfing/issues/684)) ([ac9f286](https://github.com/Primitiv0/seatsurfing/commit/ac9f286ee9b79649694baa059370e300a32b8792))
* **deps:** bump eslint-config-next from 15.2.2 to 15.2.3 in /booking-ui ([#685](https://github.com/Primitiv0/seatsurfing/issues/685)) ([bc7af15](https://github.com/Primitiv0/seatsurfing/commit/bc7af15c840b8ad46389ed53dfddd30dc403ac5d))
* **deps:** bump eslint-config-next from 15.2.3 to 15.2.4 in /admin-ui ([#718](https://github.com/Primitiv0/seatsurfing/issues/718)) ([befecbb](https://github.com/Primitiv0/seatsurfing/commit/befecbb39449b19f822dc0f9cd5624cba862b134))
* **deps:** bump eslint-config-next from 15.2.3 to 15.2.4 in /booking-ui ([#720](https://github.com/Primitiv0/seatsurfing/issues/720)) ([7fb3b29](https://github.com/Primitiv0/seatsurfing/commit/7fb3b29b4600fa11eda993dc2ec88346d77e9160))
* **deps:** bump eslint-config-next from 15.2.4 to 15.3.0 in /admin-ui ([#772](https://github.com/Primitiv0/seatsurfing/issues/772)) ([a718aab](https://github.com/Primitiv0/seatsurfing/commit/a718aab0b948adaf69e2ed1f32ce6a218115c22b))
* **deps:** bump eslint-config-next from 15.2.4 to 15.3.0 in /booking-ui ([#775](https://github.com/Primitiv0/seatsurfing/issues/775)) ([6f7f60b](https://github.com/Primitiv0/seatsurfing/commit/6f7f60b270e4186b9557d4f2b0627c324ba75d16))
* **deps:** bump eslint-config-next from 15.3.0 to 15.3.1 in /admin-ui ([#790](https://github.com/Primitiv0/seatsurfing/issues/790)) ([61ac4a7](https://github.com/Primitiv0/seatsurfing/commit/61ac4a779c4b9882813778a1d1a7ae775fd85dc2))
* **deps:** bump eslint-config-next from 15.3.0 to 15.3.1 in /booking-ui ([#792](https://github.com/Primitiv0/seatsurfing/issues/792)) ([f96af83](https://github.com/Primitiv0/seatsurfing/commit/f96af83a028308ef2574222ba56f4dd39b768462))
* **deps:** bump eslint-config-next from 15.3.1 to 15.3.2 in /admin-ui ([#840](https://github.com/Primitiv0/seatsurfing/issues/840)) ([f61d72f](https://github.com/Primitiv0/seatsurfing/commit/f61d72fd7858e73b8a24a089e29348a7f7979da3))
* **deps:** bump eslint-config-next from 15.3.1 to 15.3.2 in /booking-ui ([#844](https://github.com/Primitiv0/seatsurfing/issues/844)) ([f05f6d0](https://github.com/Primitiv0/seatsurfing/commit/f05f6d021df94b98bb51f8580696a1e9c88f8e1c))
* **deps:** bump eslint-config-next from 15.3.2 to 15.3.3 in /admin-ui ([#916](https://github.com/Primitiv0/seatsurfing/issues/916)) ([ac13d84](https://github.com/Primitiv0/seatsurfing/commit/ac13d84d585a08bf942a486e6a7e0d48263a1a27))
* **deps:** bump eslint-config-next from 15.3.2 to 15.3.3 in /booking-ui ([#917](https://github.com/Primitiv0/seatsurfing/issues/917)) ([338c2c1](https://github.com/Primitiv0/seatsurfing/commit/338c2c164f38e604495bc94ff7df51e7985e8139))
* **deps:** bump eslint-config-next from 15.3.3 to 15.3.4 in /admin-ui ([#975](https://github.com/Primitiv0/seatsurfing/issues/975)) ([453e34b](https://github.com/Primitiv0/seatsurfing/commit/453e34b0a4d0b303ddd85d54681530687b895e11))
* **deps:** bump eslint-config-next from 15.3.3 to 15.3.4 in /booking-ui ([#978](https://github.com/Primitiv0/seatsurfing/issues/978)) ([68c451c](https://github.com/Primitiv0/seatsurfing/commit/68c451ce4677ef8a9eafd76167a0b5034154f2ce))
* **deps:** bump eslint-config-next from 15.3.4 to 15.3.5 in /admin-ui ([#1047](https://github.com/Primitiv0/seatsurfing/issues/1047)) ([4b9625d](https://github.com/Primitiv0/seatsurfing/commit/4b9625df0f44f00f9f4ca8b9e2df086728a8c33e))
* **deps:** bump eslint-config-next from 15.3.4 to 15.3.5 in /booking-ui ([#1049](https://github.com/Primitiv0/seatsurfing/issues/1049)) ([9aa3667](https://github.com/Primitiv0/seatsurfing/commit/9aa366728302f49cabefae10c293721d2f76e664))
* **deps:** bump eslint-config-next from 15.3.5 to 15.4.1 in /admin-ui ([#1079](https://github.com/Primitiv0/seatsurfing/issues/1079)) ([0806ef9](https://github.com/Primitiv0/seatsurfing/commit/0806ef9f8f28cf8cc7d81058ed568dbd5e450afe))
* **deps:** bump eslint-config-next from 15.3.5 to 15.4.1 in /booking-ui ([#1083](https://github.com/Primitiv0/seatsurfing/issues/1083)) ([21f581e](https://github.com/Primitiv0/seatsurfing/commit/21f581ebb7d9f02fc1cfa15f8d467ce713cbd715))
* **deps:** bump eslint-config-next from 15.4.1 to 15.4.2 in /admin-ui ([#1098](https://github.com/Primitiv0/seatsurfing/issues/1098)) ([652ffc5](https://github.com/Primitiv0/seatsurfing/commit/652ffc5b8d891338c3bcbfdd923ed4f682387098))
* **deps:** bump eslint-config-next from 15.4.1 to 15.4.2 in /booking-ui ([#1100](https://github.com/Primitiv0/seatsurfing/issues/1100)) ([27f1959](https://github.com/Primitiv0/seatsurfing/commit/27f195952cffb2980b13d045b6d5d9cd8742e6e8))
* **deps:** bump eslint-config-next from 15.4.2 to 15.4.3 in /admin-ui ([#1107](https://github.com/Primitiv0/seatsurfing/issues/1107)) ([311cc13](https://github.com/Primitiv0/seatsurfing/commit/311cc1352c09d0587392479fdf0911de2d852556))
* **deps:** bump eslint-config-next from 15.4.2 to 15.4.3 in /booking-ui ([#1109](https://github.com/Primitiv0/seatsurfing/issues/1109)) ([899895b](https://github.com/Primitiv0/seatsurfing/commit/899895b8cbefc39d93a381264d4a92a34718933d))
* **deps:** bump eslint-config-next from 15.4.3 to 15.4.4 in /admin-ui ([#1117](https://github.com/Primitiv0/seatsurfing/issues/1117)) ([3acd7ce](https://github.com/Primitiv0/seatsurfing/commit/3acd7ce37e8c03554a23917e5ae5e79d7d48b21e))
* **deps:** bump eslint-config-next from 15.4.3 to 15.4.4 in /booking-ui ([#1121](https://github.com/Primitiv0/seatsurfing/issues/1121)) ([c8d1f28](https://github.com/Primitiv0/seatsurfing/commit/c8d1f284cb2288dac11ec36646131cf2d1ed25e9))
* **deps:** bump eslint-config-next from 15.4.4 to 15.4.5 in /admin-ui ([#1136](https://github.com/Primitiv0/seatsurfing/issues/1136)) ([c8fe53b](https://github.com/Primitiv0/seatsurfing/commit/c8fe53b4ad9107e1f24335f5158806ee3f36cf2d))
* **deps:** bump eslint-config-next from 15.4.4 to 15.4.5 in /booking-ui ([#1138](https://github.com/Primitiv0/seatsurfing/issues/1138)) ([ec316bc](https://github.com/Primitiv0/seatsurfing/commit/ec316bc24762cd927dd86647a0d833d990a799bb))
* **deps:** bump eslint-config-next from 15.4.5 to 15.4.6 in /admin-ui ([#1162](https://github.com/Primitiv0/seatsurfing/issues/1162)) ([5e4f4f7](https://github.com/Primitiv0/seatsurfing/commit/5e4f4f74ec1739107d67a5eed0f661fe8aae1d4c))
* **deps:** bump eslint-config-next from 15.4.5 to 15.4.6 in /booking-ui ([#1164](https://github.com/Primitiv0/seatsurfing/issues/1164)) ([3d32866](https://github.com/Primitiv0/seatsurfing/commit/3d32866eb484bef5265b77fe1f513a549aad71f9))
* **deps:** bump eslint-config-next from 15.4.6 to 15.5.0 in /admin-ui ([#1201](https://github.com/Primitiv0/seatsurfing/issues/1201)) ([9e07feb](https://github.com/Primitiv0/seatsurfing/commit/9e07febff08ad6cf0c746f93939c5f02982295e2))
* **deps:** bump eslint-config-next from 15.4.6 to 15.5.0 in /booking-ui ([#1203](https://github.com/Primitiv0/seatsurfing/issues/1203)) ([c317bc8](https://github.com/Primitiv0/seatsurfing/commit/c317bc8ad24f7e0ffacaa4bdfee9c91d07e53582))
* **deps:** bump eslint-config-next from 15.5.0 to 15.5.2 in /admin-ui ([#1227](https://github.com/Primitiv0/seatsurfing/issues/1227)) ([6ad0947](https://github.com/Primitiv0/seatsurfing/commit/6ad0947bb14b3169077403a2220ac43757700814))
* **deps:** bump eslint-config-next from 15.5.0 to 15.5.2 in /booking-ui ([#1228](https://github.com/Primitiv0/seatsurfing/issues/1228)) ([a0a7779](https://github.com/Primitiv0/seatsurfing/commit/a0a7779099069267c29d4acf9d0e3e24bf476365))
* **deps:** bump eslint-config-next from 15.5.2 to 15.5.3 in /admin-ui ([#1274](https://github.com/Primitiv0/seatsurfing/issues/1274)) ([846e32f](https://github.com/Primitiv0/seatsurfing/commit/846e32f6fc80f1a6a191e076aa843e3800d98162))
* **deps:** bump eslint-config-next from 15.5.2 to 15.5.3 in /booking-ui ([#1276](https://github.com/Primitiv0/seatsurfing/issues/1276)) ([28530cc](https://github.com/Primitiv0/seatsurfing/commit/28530cca5bb0ed8375631297e5e3a0c2143988da))
* **deps:** bump eslint-config-next from 15.5.3 to 15.5.4 in /admin-ui ([#1312](https://github.com/Primitiv0/seatsurfing/issues/1312)) ([d2e0837](https://github.com/Primitiv0/seatsurfing/commit/d2e0837dcfb0be5929eb6f256ca852a2b24acb85))
* **deps:** bump eslint-config-next from 15.5.3 to 15.5.4 in /booking-ui ([#1314](https://github.com/Primitiv0/seatsurfing/issues/1314)) ([b848802](https://github.com/Primitiv0/seatsurfing/commit/b848802bc83a8f5c5d43074864441d52495044bf))
* **deps:** bump excellentexport from 3.9.9 to 3.9.10 in /admin-ui ([#1063](https://github.com/Primitiv0/seatsurfing/issues/1063)) ([d4f4276](https://github.com/Primitiv0/seatsurfing/commit/d4f42763f3d6fd4bef767b2208e4f96368f64e7d))
* **deps:** bump github.com/golang-jwt/jwt/v5 from 5.2.3 to 5.3.0 in /server ([#1139](https://github.com/Primitiv0/seatsurfing/issues/1139)) ([d0a798d](https://github.com/Primitiv0/seatsurfing/commit/d0a798d57c20b617a7333584bef89ec895a87dd0))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.63 to 1.0.64 in /server ([#1166](https://github.com/Primitiv0/seatsurfing/issues/1166)) ([10b7e13](https://github.com/Primitiv0/seatsurfing/commit/10b7e13c9d98f61d1ae0afb4989107cdde9531e4))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.64 to 1.0.65 in /server ([#1308](https://github.com/Primitiv0/seatsurfing/issues/1308)) ([4191182](https://github.com/Primitiv0/seatsurfing/commit/4191182b7cfd7fe71b6af5b243d695d54d858606))
* **deps:** bump github.com/valkey-io/valkey-go from 1.0.65 to 1.0.66 in /server ([#1319](https://github.com/Primitiv0/seatsurfing/issues/1319)) ([af7bbb1](https://github.com/Primitiv0/seatsurfing/commit/af7bbb14c527cf2e7fa3ae373fc7844e41af9da7))
* **deps:** bump golang-jwt to v5 ([#894](https://github.com/Primitiv0/seatsurfing/issues/894)) ([489c6ee](https://github.com/Primitiv0/seatsurfing/commit/489c6ee881bd82a816b9d117dbe2f6118ccc07e1))
* **deps:** bump golang.org/x/crypto from 0.40.0 to 0.41.0 in /server ([#1165](https://github.com/Primitiv0/seatsurfing/issues/1165)) ([fb86183](https://github.com/Primitiv0/seatsurfing/commit/fb86183ba3132af29da31f37822315d2b5c55e89))
* **deps:** bump golang.org/x/crypto from 0.41.0 to 0.42.0 in /server ([#1252](https://github.com/Primitiv0/seatsurfing/issues/1252)) ([fb3dddf](https://github.com/Primitiv0/seatsurfing/commit/fb3dddfded7002b974cb89a4cd8ff0c0aa4487f8))
* **deps:** bump golang.org/x/oauth2 from 0.30.0 to 0.31.0 in /server ([#1253](https://github.com/Primitiv0/seatsurfing/issues/1253)) ([33ea6f0](https://github.com/Primitiv0/seatsurfing/commit/33ea6f0706e88f1ba1d7406e105ed58ea09ca5f4))
* **deps:** bump i18next from 24.2.3 to 25.0.1 in /commons/ts ([#794](https://github.com/Primitiv0/seatsurfing/issues/794)) ([80f7065](https://github.com/Primitiv0/seatsurfing/commit/80f706513d2f84ceb2845eed8af864d68de558f5))
* **deps:** bump i18next from 25.0.1 to 25.0.2 in /commons/ts ([#815](https://github.com/Primitiv0/seatsurfing/issues/815)) ([2378a1a](https://github.com/Primitiv0/seatsurfing/commit/2378a1a68abe53685795042efc7aef2102697fcd))
* **deps:** bump i18next from 25.0.2 to 25.1.1 in /commons/ts ([#836](https://github.com/Primitiv0/seatsurfing/issues/836)) ([a5419be](https://github.com/Primitiv0/seatsurfing/commit/a5419be40dd565177bcd009b4dbf8e1b2b2fa745))
* **deps:** bump i18next from 25.1.1 to 25.1.2 in /commons/ts ([#856](https://github.com/Primitiv0/seatsurfing/issues/856)) ([c2acaba](https://github.com/Primitiv0/seatsurfing/commit/c2acaba4cb7332e319c28cc51b24f38cc42758a1))
* **deps:** bump i18next from 25.1.2 to 25.1.3 in /commons/ts ([#866](https://github.com/Primitiv0/seatsurfing/issues/866)) ([a0b10ad](https://github.com/Primitiv0/seatsurfing/commit/a0b10adc3f34259ec7f286190865f72e9f0705ca))
* **deps:** bump i18next from 25.1.3 to 25.2.0 in /commons/ts ([#879](https://github.com/Primitiv0/seatsurfing/issues/879)) ([a68f1ce](https://github.com/Primitiv0/seatsurfing/commit/a68f1ce03fb234c56c539c11d4eb28c432b17c7a))
* **deps:** bump i18next from 25.2.0 to 25.2.1 in /commons/ts ([#904](https://github.com/Primitiv0/seatsurfing/issues/904)) ([32b5dc0](https://github.com/Primitiv0/seatsurfing/commit/32b5dc08d6f234b99ef9906a0deadf141bb3d811))
* **deps:** bump i18next-browser-languagedetector from 8.0.4 to 8.0.5 in /admin-ui ([#801](https://github.com/Primitiv0/seatsurfing/issues/801)) ([c0ee28d](https://github.com/Primitiv0/seatsurfing/commit/c0ee28db2e3094678e373e126551bb41293ac5a7))
* **deps:** bump i18next-browser-languagedetector from 8.0.5 to 8.1.0 in /admin-ui ([#820](https://github.com/Primitiv0/seatsurfing/issues/820)) ([62a1f56](https://github.com/Primitiv0/seatsurfing/commit/62a1f56f7b6d5ba34cd6e0eb2ba70beaa6a2f840))
* **deps:** bump i18next-browser-languagedetector from 8.1.0 to 8.2.0 in /admin-ui ([#959](https://github.com/Primitiv0/seatsurfing/issues/959)) ([8c08973](https://github.com/Primitiv0/seatsurfing/commit/8c08973caf086ea25fb18be12d31c82f4de47400))
* **deps:** bump library/golang from 1.24-bookworm to 1.25-bookworm ([#1182](https://github.com/Primitiv0/seatsurfing/issues/1182)) ([5062367](https://github.com/Primitiv0/seatsurfing/commit/5062367cb59760ebbb44d748cf0e17f352ed9b60))
* **deps:** bump next from 15.2.2 to 15.2.3 in /admin-ui ([#683](https://github.com/Primitiv0/seatsurfing/issues/683)) ([015cb8f](https://github.com/Primitiv0/seatsurfing/commit/015cb8faa7847ea32b68858c440449888548179c))
* **deps:** bump next from 15.2.2 to 15.2.3 in /booking-ui ([#686](https://github.com/Primitiv0/seatsurfing/issues/686)) ([6ce69c4](https://github.com/Primitiv0/seatsurfing/commit/6ce69c48773dd50ed02863b6385f484a4b9d9480))
* **deps:** bump next from 15.2.3 to 15.2.4 in /admin-ui ([#717](https://github.com/Primitiv0/seatsurfing/issues/717)) ([9ff7c46](https://github.com/Primitiv0/seatsurfing/commit/9ff7c469dbf8b0e3a7876d1e42528349b429bba2))
* **deps:** bump next from 15.2.3 to 15.2.4 in /booking-ui ([#719](https://github.com/Primitiv0/seatsurfing/issues/719)) ([e219e88](https://github.com/Primitiv0/seatsurfing/commit/e219e880ab3e21e003ceacbc3b3e9e83b824268e))
* **deps:** bump next from 15.2.4 to 15.3.0 in /admin-ui ([#773](https://github.com/Primitiv0/seatsurfing/issues/773)) ([dfa5dfe](https://github.com/Primitiv0/seatsurfing/commit/dfa5dfe7d661f76d89f849a24e20dbb28cfe578c))
* **deps:** bump next from 15.2.4 to 15.3.0 in /booking-ui ([#774](https://github.com/Primitiv0/seatsurfing/issues/774)) ([57b5655](https://github.com/Primitiv0/seatsurfing/commit/57b5655e0a5a5226312a31473abe9f7225ce59f8))
* **deps:** bump next from 15.3.0 to 15.3.1 in /admin-ui ([#788](https://github.com/Primitiv0/seatsurfing/issues/788)) ([f751ceb](https://github.com/Primitiv0/seatsurfing/commit/f751ceb76a17103545be7afbce8c404670576b35))
* **deps:** bump next from 15.3.0 to 15.3.1 in /booking-ui ([#791](https://github.com/Primitiv0/seatsurfing/issues/791)) ([7c50de0](https://github.com/Primitiv0/seatsurfing/commit/7c50de017469cd2640b3dcb7d4086afbdfe61329))
* **deps:** bump next from 15.3.1 to 15.3.2 in /admin-ui ([#839](https://github.com/Primitiv0/seatsurfing/issues/839)) ([39b35b3](https://github.com/Primitiv0/seatsurfing/commit/39b35b3d0724d214c133cb1d8ad4cac37322ba40))
* **deps:** bump next from 15.3.1 to 15.3.2 in /booking-ui ([#842](https://github.com/Primitiv0/seatsurfing/issues/842)) ([e98d90b](https://github.com/Primitiv0/seatsurfing/commit/e98d90b18512b092f78e4492a8b83a0fb08e4614))
* **deps:** bump next from 15.3.2 to 15.3.3 in /admin-ui ([#915](https://github.com/Primitiv0/seatsurfing/issues/915)) ([9bbac5a](https://github.com/Primitiv0/seatsurfing/commit/9bbac5ab19d16abecc2836c253588e07eb9c1592))
* **deps:** bump next from 15.3.2 to 15.3.3 in /booking-ui ([#919](https://github.com/Primitiv0/seatsurfing/issues/919)) ([26fd159](https://github.com/Primitiv0/seatsurfing/commit/26fd1594e4d6c6dbd304ac8ce1b9111ce8211e9d))
* **deps:** bump next from 15.3.3 to 15.3.4 in /admin-ui ([#976](https://github.com/Primitiv0/seatsurfing/issues/976)) ([1711704](https://github.com/Primitiv0/seatsurfing/commit/1711704238e5f93a938c79514f08e63cf146dcdc))
* **deps:** bump next from 15.3.3 to 15.3.4 in /booking-ui ([#977](https://github.com/Primitiv0/seatsurfing/issues/977)) ([0838f87](https://github.com/Primitiv0/seatsurfing/commit/0838f879eb6178822b3199b089da9e5f39064a69))
* **deps:** bump next from 15.3.4 to 15.3.5 in /admin-ui ([#1048](https://github.com/Primitiv0/seatsurfing/issues/1048)) ([d703a79](https://github.com/Primitiv0/seatsurfing/commit/d703a795f557a41431b8240c1c4e74af520498f8))
* **deps:** bump next from 15.3.4 to 15.3.5 in /booking-ui ([#1050](https://github.com/Primitiv0/seatsurfing/issues/1050)) ([da2c0bd](https://github.com/Primitiv0/seatsurfing/commit/da2c0bd8071c913158f4177e28ae6b676308d4da))
* **deps:** bump next from 15.3.5 to 15.4.1 in /admin-ui ([#1080](https://github.com/Primitiv0/seatsurfing/issues/1080)) ([ef49cd5](https://github.com/Primitiv0/seatsurfing/commit/ef49cd5620456855439f425ede2667ddf6639aa5))
* **deps:** bump next from 15.3.5 to 15.4.1 in /booking-ui ([#1084](https://github.com/Primitiv0/seatsurfing/issues/1084)) ([0586e58](https://github.com/Primitiv0/seatsurfing/commit/0586e58e30770d758a516ecf4f0aba3640e886c9))
* **deps:** bump next from 15.4.1 to 15.4.2 in /admin-ui ([#1096](https://github.com/Primitiv0/seatsurfing/issues/1096)) ([54a4ba9](https://github.com/Primitiv0/seatsurfing/commit/54a4ba95344be76e79c0cdc9ebb5a6b813411f47))
* **deps:** bump next from 15.4.1 to 15.4.2 in /booking-ui ([#1099](https://github.com/Primitiv0/seatsurfing/issues/1099)) ([b2ba650](https://github.com/Primitiv0/seatsurfing/commit/b2ba65088891d0187aa761948c03e0e4913c5a3f))
* **deps:** bump next from 15.4.2 to 15.4.3 in /admin-ui ([#1108](https://github.com/Primitiv0/seatsurfing/issues/1108)) ([27c94a2](https://github.com/Primitiv0/seatsurfing/commit/27c94a2d8ca93058d3fcba8ee5f6aa55877fdd20))
* **deps:** bump next from 15.4.2 to 15.4.3 in /booking-ui ([#1110](https://github.com/Primitiv0/seatsurfing/issues/1110)) ([ddd22b1](https://github.com/Primitiv0/seatsurfing/commit/ddd22b1d773762592409dce208d2a3cb92b25b1b))
* **deps:** bump next from 15.4.3 to 15.4.4 in /admin-ui ([#1119](https://github.com/Primitiv0/seatsurfing/issues/1119)) ([4998ba2](https://github.com/Primitiv0/seatsurfing/commit/4998ba2453e37b243913362630d6dd639ba3d458))
* **deps:** bump next from 15.4.3 to 15.4.4 in /booking-ui ([#1120](https://github.com/Primitiv0/seatsurfing/issues/1120)) ([0929268](https://github.com/Primitiv0/seatsurfing/commit/0929268e538935d4f33f2ef5468128bcb3878437))
* **deps:** bump next from 15.4.4 to 15.4.5 in /admin-ui ([#1135](https://github.com/Primitiv0/seatsurfing/issues/1135)) ([1da8e63](https://github.com/Primitiv0/seatsurfing/commit/1da8e630de03ace6ee2561440585448dac8cded9))
* **deps:** bump next from 15.4.4 to 15.4.5 in /booking-ui ([#1137](https://github.com/Primitiv0/seatsurfing/issues/1137)) ([304ee72](https://github.com/Primitiv0/seatsurfing/commit/304ee72480f39f490e1c523a1777490dc004c585))
* **deps:** bump next from 15.4.5 to 15.4.6 in /admin-ui ([#1161](https://github.com/Primitiv0/seatsurfing/issues/1161)) ([7b43a8e](https://github.com/Primitiv0/seatsurfing/commit/7b43a8ec596df8c18892bde752c44d109f13d01b))
* **deps:** bump next from 15.4.5 to 15.4.6 in /booking-ui ([#1163](https://github.com/Primitiv0/seatsurfing/issues/1163)) ([3923062](https://github.com/Primitiv0/seatsurfing/commit/39230624183193837839079a98aeadacaed90f68))
* **deps:** bump next from 15.4.6 to 15.5.0 in /admin-ui ([#1200](https://github.com/Primitiv0/seatsurfing/issues/1200)) ([f5dfbd5](https://github.com/Primitiv0/seatsurfing/commit/f5dfbd5978ec11c5f20e47dc46c9a8f7fd5d52bf))
* **deps:** bump next from 15.4.6 to 15.5.0 in /booking-ui ([#1202](https://github.com/Primitiv0/seatsurfing/issues/1202)) ([9f21fac](https://github.com/Primitiv0/seatsurfing/commit/9f21fac9509c88177567cfbd8c6b2f798c5b717a))
* **deps:** bump next from 15.5.0 to 15.5.2 in /admin-ui ([#1226](https://github.com/Primitiv0/seatsurfing/issues/1226)) ([f5b7d8d](https://github.com/Primitiv0/seatsurfing/commit/f5b7d8de109374341d21f30e6f8706e6238f9dd3))
* **deps:** bump next from 15.5.0 to 15.5.2 in /booking-ui ([#1225](https://github.com/Primitiv0/seatsurfing/issues/1225)) ([c4d2938](https://github.com/Primitiv0/seatsurfing/commit/c4d2938e4caaacf3265effb9816b84ba72786ec5))
* **deps:** bump next from 15.5.2 to 15.5.3 in /admin-ui ([#1273](https://github.com/Primitiv0/seatsurfing/issues/1273)) ([973797b](https://github.com/Primitiv0/seatsurfing/commit/973797bac0e1578dc42dd851b9db8c2b0a56a2c2))
* **deps:** bump next from 15.5.2 to 15.5.3 in /booking-ui ([#1275](https://github.com/Primitiv0/seatsurfing/issues/1275)) ([185faaf](https://github.com/Primitiv0/seatsurfing/commit/185faaf7bbba3dfc29e1cbd7ceace0649397aa84))
* **deps:** bump next from 15.5.3 to 15.5.4 in /admin-ui ([#1311](https://github.com/Primitiv0/seatsurfing/issues/1311)) ([239d366](https://github.com/Primitiv0/seatsurfing/commit/239d3660cd976887861eed44df08063945f8ba76))
* **deps:** bump next from 15.5.3 to 15.5.4 in /booking-ui ([#1313](https://github.com/Primitiv0/seatsurfing/issues/1313)) ([5b03aa9](https://github.com/Primitiv0/seatsurfing/commit/5b03aa931935a7d39e4fa43107a108e55ad7baed))
* **deps:** bump react-bootstrap from 2.10.9 to 2.10.10 in /admin-ui ([#852](https://github.com/Primitiv0/seatsurfing/issues/852)) ([28de7ea](https://github.com/Primitiv0/seatsurfing/commit/28de7eac544c317c1947c6eaab4ef3821f3091bd))
* **deps:** bump react-bootstrap from 2.10.9 to 2.10.10 in /booking-ui ([#855](https://github.com/Primitiv0/seatsurfing/issues/855)) ([e1eb065](https://github.com/Primitiv0/seatsurfing/commit/e1eb06527c298d49e62c762e68020f58a8d5652c))
* **deps:** bump react-date-picker from 11.0.0 to 12.0.1 in /admin-ui ([#1153](https://github.com/Primitiv0/seatsurfing/issues/1153)) ([1228816](https://github.com/Primitiv0/seatsurfing/commit/12288168078917e8752d4a98b3312b6cc1f9ebe3))
* **deps:** bump react-date-picker from 11.0.0 to 12.0.1 in /booking-ui ([#1154](https://github.com/Primitiv0/seatsurfing/issues/1154)) ([201e0bb](https://github.com/Primitiv0/seatsurfing/commit/201e0bb142d5c5b80de7b30af9289236f3031d83))
* **deps:** bump react-datetime-picker from 6.0.1 to 7.0.1 in /admin-ui ([#1156](https://github.com/Primitiv0/seatsurfing/issues/1156)) ([e8cc0cd](https://github.com/Primitiv0/seatsurfing/commit/e8cc0cd5463bf7f531084d79bd73fa981cc01bc5))
* **deps:** bump react-datetime-picker from 6.0.1 to 7.0.1 in /booking-ui ([#1155](https://github.com/Primitiv0/seatsurfing/issues/1155)) ([ec19d00](https://github.com/Primitiv0/seatsurfing/commit/ec19d00453a1c6edd87c97ce4f208d07507979ef))
* **deps:** bump react-dom from 19.0.0 to 19.1.0 in /admin-ui ([#738](https://github.com/Primitiv0/seatsurfing/issues/738)) ([430658e](https://github.com/Primitiv0/seatsurfing/commit/430658e34bb9805fce3abaa620a931764cd9e9fd))
* **deps:** bump react-dom from 19.0.0 to 19.1.0 in /booking-ui ([#739](https://github.com/Primitiv0/seatsurfing/issues/739)) ([44e1571](https://github.com/Primitiv0/seatsurfing/commit/44e1571e35da43f24b3ec3ffe4d79af83606b239))
* **deps:** bump react-dom from 19.1.0 to 19.1.1 in /admin-ui ([#1127](https://github.com/Primitiv0/seatsurfing/issues/1127)) ([9fd6e0c](https://github.com/Primitiv0/seatsurfing/commit/9fd6e0c1360e4ec9d15aa2d018e4923e7bd031a0))
* **deps:** bump react-dom from 19.1.0 to 19.1.1 in /booking-ui ([#1130](https://github.com/Primitiv0/seatsurfing/issues/1130)) ([3fe4af8](https://github.com/Primitiv0/seatsurfing/commit/3fe4af8b8c40c82af7c0fe6b8ac6ef90a15219a3))
* **deps:** bump react-i18next from 15.4.1 to 15.5.1 in /admin-ui ([#803](https://github.com/Primitiv0/seatsurfing/issues/803)) ([8431c03](https://github.com/Primitiv0/seatsurfing/commit/8431c039f1597a26764b7d3f0f246c6b9f1f0429))
* **deps:** bump react-i18next from 15.4.1 to 15.5.1 in /booking-ui ([#804](https://github.com/Primitiv0/seatsurfing/issues/804)) ([10afd52](https://github.com/Primitiv0/seatsurfing/commit/10afd52d174094bd09eb1a1367a62122169d0947))
* **deps:** bump react-i18next from 15.5.1 to 15.5.2 in /admin-ui ([#896](https://github.com/Primitiv0/seatsurfing/issues/896)) ([d4e7433](https://github.com/Primitiv0/seatsurfing/commit/d4e743362f3a4a7bb20db848b0616ccc314c0706))
* **deps:** bump react-i18next from 15.5.1 to 15.5.2 in /booking-ui ([#897](https://github.com/Primitiv0/seatsurfing/issues/897)) ([dcea359](https://github.com/Primitiv0/seatsurfing/commit/dcea3599904d2d3b0ab3fe0b212947a6b2731d3b))
* **deps:** bump react-i18next from 15.5.2 to 15.5.3 in /admin-ui ([#961](https://github.com/Primitiv0/seatsurfing/issues/961)) ([e8f216b](https://github.com/Primitiv0/seatsurfing/commit/e8f216bebbe8886306a8dac48df151477ec51621))
* **deps:** bump react-i18next from 15.5.2 to 15.5.3 in /booking-ui ([#964](https://github.com/Primitiv0/seatsurfing/issues/964)) ([6c27a99](https://github.com/Primitiv0/seatsurfing/commit/6c27a99adf2769796950041397be2a7be34cbb6b))
* **deps:** bump react-router-dom from 7.3.0 to 7.4.0 in /admin-ui ([#691](https://github.com/Primitiv0/seatsurfing/issues/691)) ([3577f2c](https://github.com/Primitiv0/seatsurfing/commit/3577f2c16a1325514bc127d13e78cbeca8e677b3))
* **deps:** bump react-router-dom from 7.4.0 to 7.4.1 in /admin-ui ([#737](https://github.com/Primitiv0/seatsurfing/issues/737)) ([f03b939](https://github.com/Primitiv0/seatsurfing/commit/f03b9394dd53b1e734c52c6cfc45c20425f06688))
* **deps:** bump react-router-dom from 7.4.1 to 7.5.0 in /admin-ui ([#755](https://github.com/Primitiv0/seatsurfing/issues/755)) ([48b04b7](https://github.com/Primitiv0/seatsurfing/commit/48b04b7a51cd14f357fbd16ad7a8d37791a750ce))
* **deps:** bump react-router-dom from 7.5.0 to 7.5.1 in /admin-ui ([#789](https://github.com/Primitiv0/seatsurfing/issues/789)) ([300dfb6](https://github.com/Primitiv0/seatsurfing/commit/300dfb607903b37c283dfbd43cbed798242d7dab))
* **deps:** bump react-router-dom from 7.5.1 to 7.5.2 in /admin-ui ([#805](https://github.com/Primitiv0/seatsurfing/issues/805)) ([1d58926](https://github.com/Primitiv0/seatsurfing/commit/1d58926913d43958e207eacd9d413e31c2469553))
* **deps:** bump react-router-dom from 7.5.2 to 7.5.3 in /admin-ui ([#819](https://github.com/Primitiv0/seatsurfing/issues/819)) ([9d0029b](https://github.com/Primitiv0/seatsurfing/commit/9d0029b2bb9e1a12ca46a0842c3217eeece98ddf))
* **deps:** bump react-router-dom from 7.5.3 to 7.6.0 in /admin-ui ([#847](https://github.com/Primitiv0/seatsurfing/issues/847)) ([f273a31](https://github.com/Primitiv0/seatsurfing/commit/f273a312e9539c74edb6cb2028fef582c5d0d8e9))
* **deps:** bump react-router-dom from 7.6.0 to 7.6.1 in /admin-ui ([#903](https://github.com/Primitiv0/seatsurfing/issues/903)) ([dad6b7f](https://github.com/Primitiv0/seatsurfing/commit/dad6b7f27c67756f0d4d5d0893257887250352b7))
* **deps:** bump react-router-dom from 7.6.1 to 7.6.2 in /admin-ui ([#931](https://github.com/Primitiv0/seatsurfing/issues/931)) ([55e3227](https://github.com/Primitiv0/seatsurfing/commit/55e3227163f00be6bc91bdd666a9aee7d479763d))
* **deps:** bump react-router-dom from 7.6.2 to 7.6.3 in /admin-ui ([#1021](https://github.com/Primitiv0/seatsurfing/issues/1021)) ([85cd91a](https://github.com/Primitiv0/seatsurfing/commit/85cd91a9f04a0abbc140b31ba5c5d05205c838ca))
* **deps:** bump react-router-dom from 7.6.3 to 7.7.0 in /admin-ui ([#1089](https://github.com/Primitiv0/seatsurfing/issues/1089)) ([7dd15b9](https://github.com/Primitiv0/seatsurfing/commit/7dd15b925f900e8be23298f5924f8f7abb69baf1))
* **deps:** bump react-router-dom from 7.7.0 to 7.7.1 in /admin-ui ([#1111](https://github.com/Primitiv0/seatsurfing/issues/1111)) ([2d9d0f8](https://github.com/Primitiv0/seatsurfing/commit/2d9d0f80cac7a4015451be034a507e22e0162faf))
* **deps:** bump react-router-dom from 7.7.1 to 7.8.0 in /admin-ui ([#1160](https://github.com/Primitiv0/seatsurfing/issues/1160)) ([c41155a](https://github.com/Primitiv0/seatsurfing/commit/c41155aa9e8dbe4f20644e662248101d139d11ee))
* **deps:** bump react-router-dom from 7.8.0 to 7.8.1 in /admin-ui ([#1191](https://github.com/Primitiv0/seatsurfing/issues/1191)) ([0ad8ab2](https://github.com/Primitiv0/seatsurfing/commit/0ad8ab205001ce6c4ebf864c57fc513a4ea566b9))
* **deps:** bump react-router-dom from 7.8.1 to 7.8.2 in /admin-ui ([#1206](https://github.com/Primitiv0/seatsurfing/issues/1206)) ([c83e9bb](https://github.com/Primitiv0/seatsurfing/commit/c83e9bbe7a60043eb0b100fa1b8ce3b4a7ee39e4))
* **deps:** bump react-router-dom from 7.8.2 to 7.9.0 in /admin-ui ([#1283](https://github.com/Primitiv0/seatsurfing/issues/1283)) ([254c1b2](https://github.com/Primitiv0/seatsurfing/commit/254c1b2f23d60089e27e1283638b14abb6a0d4df))
* **deps:** bump react-router-dom from 7.9.0 to 7.9.1 in /admin-ui ([#1294](https://github.com/Primitiv0/seatsurfing/issues/1294)) ([e6aff38](https://github.com/Primitiv0/seatsurfing/commit/e6aff384a2fa7d41fc6499d9af7cb4d009bcc905))
* **deps:** bump react-router-dom from 7.9.1 to 7.9.2 in /admin-ui ([#1317](https://github.com/Primitiv0/seatsurfing/issues/1317)) ([aac9607](https://github.com/Primitiv0/seatsurfing/commit/aac96079179e7149ed06c28c266515db78d1af49))
* **deps:** bump react-tooltip from 5.28.0 to 5.28.1 in /booking-ui ([#767](https://github.com/Primitiv0/seatsurfing/issues/767)) ([d40fae8](https://github.com/Primitiv0/seatsurfing/commit/d40fae88b69b496201869c46d1baf7435c4eb26e))
* **deps:** bump react-tooltip from 5.28.1 to 5.29.0 in /booking-ui ([#955](https://github.com/Primitiv0/seatsurfing/issues/955)) ([4aba141](https://github.com/Primitiv0/seatsurfing/commit/4aba14196c0eaf11bf906f3626ca3d1c071c007a))
* **deps:** bump react-tooltip from 5.29.0 to 5.29.1 in /booking-ui ([#971](https://github.com/Primitiv0/seatsurfing/issues/971)) ([4bcfe5c](https://github.com/Primitiv0/seatsurfing/commit/4bcfe5c3001301d6813439a22089df31534926fc))
* **deps:** bump server dependencies ([#1093](https://github.com/Primitiv0/seatsurfing/issues/1093)) ([fdfe497](https://github.com/Primitiv0/seatsurfing/commit/fdfe4973d8d70f7e71e50607d4e93d4060536486))
* **deps:** bump typescript from 5.8.2 to 5.8.3 in /commons/ts ([#765](https://github.com/Primitiv0/seatsurfing/issues/765)) ([c822e2c](https://github.com/Primitiv0/seatsurfing/commit/c822e2cd04046b96eb87731f3669727ba22da1ea))
* **deps:** bump typescript from 5.8.3 to 5.9.2 in /commons/ts ([#1141](https://github.com/Primitiv0/seatsurfing/issues/1141)) ([97cfb8d](https://github.com/Primitiv0/seatsurfing/commit/97cfb8d1d69ddba9146674a847e0bb05e45fc94f))
* **deps:** update server dependencies ([#868](https://github.com/Primitiv0/seatsurfing/issues/868)) ([a21f6f1](https://github.com/Primitiv0/seatsurfing/commit/a21f6f1e95beb5a8ea5c4e7405ea23034b6d33be))
* **deps:** upgrade server dependencies ([#1072](https://github.com/Primitiv0/seatsurfing/issues/1072)) ([d02ec29](https://github.com/Primitiv0/seatsurfing/commit/d02ec29a503f1710d871d30e3f76f2270a5eebb5))
* disable "allow any user" checkbox if no auth provider exists ([#1091](https://github.com/Primitiv0/seatsurfing/issues/1091)) ([77cd89d](https://github.com/Primitiv0/seatsurfing/commit/77cd89d48a893295b538eabd56ba4ab6217ae975))
* disable password change when logging in via IdP ([#1212](https://github.com/Primitiv0/seatsurfing/issues/1212)) ([61660c9](https://github.com/Primitiv0/seatsurfing/commit/61660c9fd1b513fce8f68b20f078c85f5e29a656))
* display version on preferences page in Admin UI ([#726](https://github.com/Primitiv0/seatsurfing/issues/726)) ([df48d44](https://github.com/Primitiv0/seatsurfing/commit/df48d445b31086f9592f851290f785757ff1f6e2))
* do not reset approval state when updating booking ([#1261](https://github.com/Primitiv0/seatsurfing/issues/1261)) ([46bb41f](https://github.com/Primitiv0/seatsurfing/commit/46bb41fd7c4a5a2c0ac4896bb12527a82fb28c7e))
* docker healthcheck ([#1236](https://github.com/Primitiv0/seatsurfing/issues/1236)) ([6e53149](https://github.com/Primitiv0/seatsurfing/commit/6e53149a62658d5d4204a29f6987157a6e91e9c7))
* docker healthcheck ([#1260](https://github.com/Primitiv0/seatsurfing/issues/1260)) ([be99c49](https://github.com/Primitiv0/seatsurfing/commit/be99c49825f53a99b1ca720ce386a7eab1a65852))
* encapsulate in-memory cache ([#995](https://github.com/Primitiv0/seatsurfing/issues/995)) ([4c657f9](https://github.com/Primitiv0/seatsurfing/commit/4c657f9cb6a1220761e09e7cf327b9cb3a79d732))
* enforce minimum length for group name ([#865](https://github.com/Primitiv0/seatsurfing/issues/865)) ([4b6d8ad](https://github.com/Primitiv0/seatsurfing/commit/4b6d8ad9b5448a5dfcd29553a8dace7f45c4c4e0))
* ensure space position is int instead of float ([#1113](https://github.com/Primitiv0/seatsurfing/issues/1113)) ([3ec437c](https://github.com/Primitiv0/seatsurfing/commit/3ec437c0c78c3f9781768c9a7ad1f43987aa8b52))
* ensure that a recurring booking includes start date's weekday (frontend) ([#1018](https://github.com/Primitiv0/seatsurfing/issues/1018)) ([a6be286](https://github.com/Primitiv0/seatsurfing/commit/a6be2868e6c1444840baef56e9cd010c74e7bf21))
* error "dial tcp &lt;IP&gt;:443: connect: connection refused" when connected via HTTP ([#741](https://github.com/Primitiv0/seatsurfing/issues/741)) ([f1da980](https://github.com/Primitiv0/seatsurfing/commit/f1da9809ddd259dc51e8f8cbe8dbebc86474c768))
* fix calculation for min. booking hours ([#1231](https://github.com/Primitiv0/seatsurfing/issues/1231)) ([636b30f](https://github.com/Primitiv0/seatsurfing/commit/636b30f3d311ff30ef4481819a7deb3a890cf1a1))
* handle text overflow in list view ([#980](https://github.com/Primitiv0/seatsurfing/issues/980)) ([7b883b7](https://github.com/Primitiv0/seatsurfing/commit/7b883b7f0cc49e10ea48b5a613b5b2afbdc8b7ba))
* hide "cancel upcoming bookings" checkbox if not my booking ([#1038](https://github.com/Primitiv0/seatsurfing/issues/1038)) ([2dfb5d8](https://github.com/Primitiv0/seatsurfing/commit/2dfb5d8e1cb136bb1f08de539f28fb194360370a))
* highlight items in Admin UI Sidebar ([#1086](https://github.com/Primitiv0/seatsurfing/issues/1086)) ([03fb359](https://github.com/Primitiv0/seatsurfing/commit/03fb3590597d0ea3fc0febdf754115f0c448afaa))
* improve adding and checking custom domains ([#777](https://github.com/Primitiv0/seatsurfing/issues/777)) ([9cacc6c](https://github.com/Primitiv0/seatsurfing/commit/9cacc6c14cd569da86bb5deadbb27bccd8578027))
* improve auth/verify handling (accept user id directly) ([#873](https://github.com/Primitiv0/seatsurfing/issues/873)) ([877d481](https://github.com/Primitiv0/seatsurfing/commit/877d4819f7ed9c82d384b9ce3c335a303c9609b0))
* improve cloud upgrade hints ([#1090](https://github.com/Primitiv0/seatsurfing/issues/1090)) ([60bb808](https://github.com/Primitiv0/seatsurfing/commit/60bb8086a78ef4ac8fc58087434cb4d954a1116d))
* improve compatibility with Postgres &lt; v16 ([#679](https://github.com/Primitiv0/seatsurfing/issues/679)) ([65a3186](https://github.com/Primitiv0/seatsurfing/commit/65a3186035346d5cf9ae8ab562442329769bebbe))
* improve GetAllDaysPassedSinceSignup function ([#1187](https://github.com/Primitiv0/seatsurfing/issues/1187)) ([98ed8d1](https://github.com/Primitiv0/seatsurfing/commit/98ed8d16bcbcbe6da6565ace41cb47d9ef08419d))
* improve html email formatting ([#827](https://github.com/Primitiv0/seatsurfing/issues/827)) ([07d3322](https://github.com/Primitiv0/seatsurfing/commit/07d332225d567435fa279ab72849fd8154c922d4))
* improve plugin display in Admin UI ([#778](https://github.com/Primitiv0/seatsurfing/issues/778)) ([3c34a23](https://github.com/Primitiv0/seatsurfing/commit/3c34a2374367433ac4e0d8c723879d8d547857b6))
* improve resilience when saving locations/spaces ([#1177](https://github.com/Primitiv0/seatsurfing/issues/1177)) ([0f31067](https://github.com/Primitiv0/seatsurfing/commit/0f31067d1a8ffc53a4d56fdaf4041cb4ca9a2175))
* improved playwright test resilience ([#1025](https://github.com/Primitiv0/seatsurfing/issues/1025)) ([913a913](https://github.com/Primitiv0/seatsurfing/commit/913a913fd6a2c34f647ae96d5cbe7adf20927722))
* improved resilience and logging for auth providers ([#871](https://github.com/Primitiv0/seatsurfing/issues/871)) ([b1ab0a4](https://github.com/Primitiv0/seatsurfing/commit/b1ab0a40de72bf4ac71c0ceccaa5febd97109192))
* incorrect access token expiry ([#1176](https://github.com/Primitiv0/seatsurfing/issues/1176)) ([3f0007e](https://github.com/Primitiv0/seatsurfing/commit/3f0007ea7404559f12d113ab55e5497fcdccc893))
* incorrect html escapes ([#1009](https://github.com/Primitiv0/seatsurfing/issues/1009)) ([62e9fff](https://github.com/Primitiv0/seatsurfing/commit/62e9fff805c981dac64f3d33f1b9965574222851))
* incorrect i18n redirects in admin and booking ui ([#900](https://github.com/Primitiv0/seatsurfing/issues/900)) ([2d096f6](https://github.com/Primitiv0/seatsurfing/commit/2d096f68f845059c563db7ba11a7997f724a8d37))
* incorrect IdP URL ([#1000](https://github.com/Primitiv0/seatsurfing/issues/1000)) ([469d5d7](https://github.com/Primitiv0/seatsurfing/commit/469d5d7249c3361519d9b90911b4fdae624e571c))
* incorrect links in mail templates ([d86897f](https://github.com/Primitiv0/seatsurfing/commit/d86897f1b153deca621c038ccd96f2f54d8b421a))
* incorrect links in mail templates ([#1004](https://github.com/Primitiv0/seatsurfing/issues/1004)) ([6310001](https://github.com/Primitiv0/seatsurfing/commit/6310001715cb316502965400a9b0cd771eb44517))
* incorrect timezone when querying availability without params ([#943](https://github.com/Primitiv0/seatsurfing/issues/943)) ([29d446d](https://github.com/Primitiv0/seatsurfing/commit/29d446d107a8b22171f4c5a4d31292800a1e2cbe))
* **lang:** add Polish translations ([#1194](https://github.com/Primitiv0/seatsurfing/issues/1194)) ([6fbbae6](https://github.com/Primitiv0/seatsurfing/commit/6fbbae615eafd64211a5a284b35fe6f9bd95fb65))
* **lang:** add Spanish translation ([#1208](https://github.com/Primitiv0/seatsurfing/issues/1208)) ([ea868b5](https://github.com/Primitiv0/seatsurfing/commit/ea868b5d26873a251702e9c51be56fede130d789))
* login via confluence app ([#1005](https://github.com/Primitiv0/seatsurfing/issues/1005)) ([435d4c7](https://github.com/Primitiv0/seatsurfing/commit/435d4c7939dd9839f3fb3a9689c786410d9cd7fb))
* make booking subject readonly for past bookings ([#1268](https://github.com/Primitiv0/seatsurfing/issues/1268)) ([a696e64](https://github.com/Primitiv0/seatsurfing/commit/a696e64a4c5bc5ce90b69d49a752b721a4189015))
* make i18n redirect more resilient ([#898](https://github.com/Primitiv0/seatsurfing/issues/898)) ([06f9163](https://github.com/Primitiv0/seatsurfing/commit/06f916390d100cf3e110f8d59294e33b34ec44cb))
* make language changes persistent ([#735](https://github.com/Primitiv0/seatsurfing/issues/735)) ([f33355d](https://github.com/Primitiv0/seatsurfing/commit/f33355d39a5b5d0ad4e77e4dbbae2286ac6af718))
* make sure random code generator always returns a 6 digit code ([#1145](https://github.com/Primitiv0/seatsurfing/issues/1145)) ([794a913](https://github.com/Primitiv0/seatsurfing/commit/794a913e246c0b9d1f7314d94bd4b7434aea7b0e))
* max booking duration not respected in daily basis booking mode ([#705](https://github.com/Primitiv0/seatsurfing/issues/705)) ([8db649e](https://github.com/Primitiv0/seatsurfing/commit/8db649e855cfdd1a12ea250092c2c894e2c37cd2))
* move admin setting "allowAnyUser" to auth provider section and add tooltip ([#949](https://github.com/Primitiv0/seatsurfing/issues/949)) ([27090fb](https://github.com/Primitiv0/seatsurfing/commit/27090fb3c34d702d403c0ab550a42eaec44b6575))
* multi-day bookings can fail ([#723](https://github.com/Primitiv0/seatsurfing/issues/723)) ([88eff18](https://github.com/Primitiv0/seatsurfing/commit/88eff18fa5f655eff4286f09e29b379d13ec2f24))
* nginx reverse proxy improvements ([#951](https://github.com/Primitiv0/seatsurfing/issues/951)) ([831a3bf](https://github.com/Primitiv0/seatsurfing/commit/831a3bf552db044610f009e9ad3759d73469a201))
* omit location in space response ([#698](https://github.com/Primitiv0/seatsurfing/issues/698)) ([a343a62](https://github.com/Primitiv0/seatsurfing/commit/a343a6268041051f245ba5a7f27f4c72af917e1f))
* omit markup when creating recurring bookings ([#990](https://github.com/Primitiv0/seatsurfing/issues/990)) ([70f7397](https://github.com/Primitiv0/seatsurfing/commit/70f7397ad7cb9268c0e03a8987c169f0911860b4))
* optimize language handling in Admin and Booking UI ([#714](https://github.com/Primitiv0/seatsurfing/issues/714)) ([37e64d4](https://github.com/Primitiv0/seatsurfing/commit/37e64d461811dd8fd3c368a66efd21752846a523))
* prevent clipping of search widget (Booking UI) ([#768](https://github.com/Primitiv0/seatsurfing/issues/768)) ([b30ce06](https://github.com/Primitiv0/seatsurfing/commit/b30ce06bc73775703b1ceb6f81c567f3bf38043d))
* prevent crash when a weekly recurring booking does not include start date's weekday (backend) ([#1013](https://github.com/Primitiv0/seatsurfing/issues/1013)) ([ba8ade4](https://github.com/Primitiv0/seatsurfing/commit/ba8ade4b4fcf148a4c55bd2e39df64ac186903b6))
* prevent crash when reading email address from auth provider response fails ([#688](https://github.com/Primitiv0/seatsurfing/issues/688)) ([d452961](https://github.com/Primitiv0/seatsurfing/commit/d4529618a2457712d978afbd29473fcfb3855072))
* prevent placing a recurring booking with zero actual bookings ([#1010](https://github.com/Primitiv0/seatsurfing/issues/1010)) ([4971c4f](https://github.com/Primitiv0/seatsurfing/commit/4971c4f23439bd8d399ec99c05dd999b2a2e719d))
* prevent whitespaces in OAuth provider client id and client secret ([#1251](https://github.com/Primitiv0/seatsurfing/issues/1251)) ([cb125e7](https://github.com/Primitiv0/seatsurfing/commit/cb125e7f8cf577ec1c56d96f9dd485fc306512f3))
* remove domain accessibility validation excludes ([#762](https://github.com/Primitiv0/seatsurfing/issues/762)) ([2398814](https://github.com/Primitiv0/seatsurfing/commit/2398814dfe4a6f89c84b9d2bf9dd02a4eb234d82))
* remove FRONTEND_URL and PUBLIC_URL ([#733](https://github.com/Primitiv0/seatsurfing/issues/733)) ([108d555](https://github.com/Primitiv0/seatsurfing/commit/108d555aab290e19306b37c54973167b43b467db))
* remove i18next dependency ([#1046](https://github.com/Primitiv0/seatsurfing/issues/1046)) ([ad1e3af](https://github.com/Primitiv0/seatsurfing/commit/ad1e3afa5cc1a006f6da5642159ae6a599496e8b))
* remove obsolete dev mode ajax prefixes ([#895](https://github.com/Primitiv0/seatsurfing/issues/895)) ([4944194](https://github.com/Primitiv0/seatsurfing/commit/49441944b3c05bb46f472cc7ff819b0afc32b925))
* remove obsolete params from development run script ([#742](https://github.com/Primitiv0/seatsurfing/issues/742)) ([1c8a9f0](https://github.com/Primitiv0/seatsurfing/commit/1c8a9f092a7d20ee68d81a4aaedb8d3bca1a04d7))
* remove obsolete route ([#893](https://github.com/Primitiv0/seatsurfing/issues/893)) ([78f4d00](https://github.com/Primitiv0/seatsurfing/commit/78f4d00a169875e0dca4965ba041aa23e48c9dd1))
* remove public version info ([#1265](https://github.com/Primitiv0/seatsurfing/issues/1265)) ([fbaca67](https://github.com/Primitiv0/seatsurfing/commit/fbaca67004da87249191fe776d07c9f03d4c7104))
* remove unused spaces from MiniMap component to fix tests and improve performance ([#887](https://github.com/Primitiv0/seatsurfing/issues/887)) ([5571624](https://github.com/Primitiv0/seatsurfing/commit/5571624a58e24754f92b5a2a4221c0820bdb6a31))
* replace "organisation" by "organization" in English translation ([#960](https://github.com/Primitiv0/seatsurfing/issues/960)) ([137bb40](https://github.com/Primitiv0/seatsurfing/commit/137bb401f8027d5453f1576f224adfc559be0f4e))
* respect location timezone when testing if booking can be canceled ([#1310](https://github.com/Primitiv0/seatsurfing/issues/1310)) ([cf32df5](https://github.com/Primitiv0/seatsurfing/commit/cf32df51c36c707e2824a899d51e8f46412731cb))
* script for adding missing translations ([#1027](https://github.com/Primitiv0/seatsurfing/issues/1027)) ([e32da8d](https://github.com/Primitiv0/seatsurfing/commit/e32da8d94a639d9a4d7a1a80615a3690239fa19f))
* send booking mail notification on update ([#826](https://github.com/Primitiv0/seatsurfing/issues/826)) ([83ba352](https://github.com/Primitiv0/seatsurfing/commit/83ba352d3eada216ffb014e64764838c46153562))
* show "no filters available info" in filter dialog ([#1037](https://github.com/Primitiv0/seatsurfing/issues/1037)) ([e52bfae](https://github.com/Primitiv0/seatsurfing/commit/e52bfae376000d3f5797d9224815dc2e2cc0d526))
* show absolute URL for auth provider's callback URL ([#950](https://github.com/Primitiv0/seatsurfing/issues/950)) ([b5fdb5d](https://github.com/Primitiv0/seatsurfing/commit/b5fdb5d20d149e346dcf09d592c40473f0ce274f))
* show number of bookings to be confirmed ([#992](https://github.com/Primitiv0/seatsurfing/issues/992)) ([9638eab](https://github.com/Primitiv0/seatsurfing/commit/9638eab6b79ae922e9866a694fbd19df510b13ea))
* show org's primary domain in OAuth callback URL ([#1266](https://github.com/Primitiv0/seatsurfing/issues/1266)) ([b34c1ed](https://github.com/Primitiv0/seatsurfing/commit/b34c1ed00cbac5bbb6f6f5d750f7d145f4fe026a))
* stop polling pending approvals after logout ([#1167](https://github.com/Primitiv0/seatsurfing/issues/1167)) ([e8eb864](https://github.com/Primitiv0/seatsurfing/commit/e8eb86423d0471c29a167f731c59dd52ce68b603))
* support attachments when sending mails via ACS ([#825](https://github.com/Primitiv0/seatsurfing/issues/825)) ([cd3b954](https://github.com/Primitiv0/seatsurfing/commit/cd3b9544a68f66a6c13b105b9482093db7644be1))
* support conditions in email templates ([#1147](https://github.com/Primitiv0/seatsurfing/issues/1147)) ([3b550a3](https://github.com/Primitiv0/seatsurfing/commit/3b550a3dc77b270374c19c57ea2c0e263063e494))
* test case for password reset ([#1007](https://github.com/Primitiv0/seatsurfing/issues/1007)) ([0817e51](https://github.com/Primitiv0/seatsurfing/commit/0817e5167b354749f18103e9e314dc3601434725))
* too much logging in domain accessibility verification ([#783](https://github.com/Primitiv0/seatsurfing/issues/783)) ([19d551d](https://github.com/Primitiv0/seatsurfing/commit/19d551d8f3bd4419ebb143927213133143ccf5f0))
* translation differences between Admin and Booking UI ([#721](https://github.com/Primitiv0/seatsurfing/issues/721)) ([51a689d](https://github.com/Primitiv0/seatsurfing/commit/51a689d444be530b80e3b36c3fac6948954269ab))
* update fallback login link in admin login form ([#1053](https://github.com/Primitiv0/seatsurfing/issues/1053)) ([8dd59b5](https://github.com/Primitiv0/seatsurfing/commit/8dd59b5c407f8e6c92c51860e964bfaf9f3f9b9f))
* update French translation in booking UI ([#1014](https://github.com/Primitiv0/seatsurfing/issues/1014)) ([ff1b96f](https://github.com/Primitiv0/seatsurfing/commit/ff1b96f5d6cbd73e4f605153db18db41ae9f8066))
* update german translation for "add" ([#1181](https://github.com/Primitiv0/seatsurfing/issues/1181)) ([a57e282](https://github.com/Primitiv0/seatsurfing/commit/a57e282b69877cfaa894b8c06226ad96926998d5))
* update link text to fallback login form ([#1052](https://github.com/Primitiv0/seatsurfing/issues/1052)) ([6cc0732](https://github.com/Primitiv0/seatsurfing/commit/6cc073234e1fa291d788b3020cbf1a3b55a17766))
* use correct timezone in availability endpoint ([#942](https://github.com/Primitiv0/seatsurfing/issues/942)) ([274c8aa](https://github.com/Primitiv0/seatsurfing/commit/274c8aa08f2b3290f2c322ebf5134015faf583e0))
* use path instead of full uri in whitelist check ([#761](https://github.com/Primitiv0/seatsurfing/issues/761)) ([adb7ca9](https://github.com/Primitiv0/seatsurfing/commit/adb7ca92890430a9d5e246b6282bf4012c468b34))
* warnings for deprecated env vars ([#989](https://github.com/Primitiv0/seatsurfing/issues/989)) ([ffcbcb1](https://github.com/Primitiv0/seatsurfing/commit/ffcbcb1539595ccbc1a1176e0e5302f0dffa749f))
